...
from assistant.models.chat_completion_request_system_message_content import ChatCompletionRequestSystemMessageContent
...
class ChatCompletionRequestSystemMessage(BaseModel):
    ...
    role: StrictStr = Field(description="The role of the messages author, in this case `system`.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "content": (
                    ChatCompletionRequestSystemMessageContent.from_dict(obj.get("content"))
