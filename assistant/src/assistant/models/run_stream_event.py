...
from assistant.models.run_stream_event_one_of import RunStreamEventOneOf
from assistant.models.run_stream_event_one_of1 import RunStreamEventOneOf1
from assistant.models.run_stream_event_one_of2 import RunStreamEventOneOf2
from assistant.models.run_stream_event_one_of3 import RunStreamEventOneOf3
from assistant.models.run_stream_event_one_of4 import RunStreamEventOneOf4
from assistant.models.run_stream_event_one_of5 import RunStreamEventOneOf5
from assistant.models.run_stream_event_one_of6 import RunStreamEventOneOf6
from assistant.models.run_stream_event_one_of7 import RunStreamEventOneOf7
from assistant.models.run_stream_event_one_of8 import RunStreamEventOneOf8
from assistant.models.run_stream_event_one_of9 import RunStreamEventOneOf9
...
RUNSTREAMEVENT_ONE_OF_SCHEMAS = ["RunStreamEventOneOf", "RunStreamEventOneOf1", "RunStreamEventOneOf2", "RunStreamEventOneOf3", "RunStreamEventOneOf4", "RunStreamEventOneOf5", "RunStreamEventOneOf6", "RunStreamEventOneOf7", "RunStreamEventOneOf8", "RunStreamEventOneOf9"]
...
class RunStreamEvent(BaseModel):
    ...
    # data type: RunStreamEventOneOf9
    oneof_schema_10_validator: Optional[RunStreamEventOneOf9] = None
    actual_instance: Optional[Union[RunStreamEventOneOf, RunStreamEventOneOf1, RunStreamEventOneOf2, RunStreamEventOneOf3, RunStreamEventOneOf4, RunStreamEventOneOf5, RunStreamEventOneOf6, RunStreamEventOneOf7, RunStreamEventOneOf8, RunStreamEventOneOf9]] = None
    one_of_schemas: List[str] = Literal["RunStreamEventOneOf", "RunStreamEventOneOf1", "RunStreamEventOneOf2", "RunStreamEventOneOf3", "RunStreamEventOneOf4", "RunStreamEventOneOf5", "RunStreamEventOneOf6", "RunStreamEventOneOf7", "RunStreamEventOneOf8", "RunStreamEventOneOf9"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, RunStreamEventOneOf8):
            ...
            match += 1
        # validate data type: RunStreamEventOneOf9
        if not isinstance(v, RunStreamEventOneOf9):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RunStreamEventOneOf9`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in RunStreamEvent with oneOf schemas: RunStreamEventOneOf, RunStreamEventOneOf1, RunStreamEventOneOf2, RunStreamEventOneOf3, RunStreamEventOneOf4, RunStreamEventOneOf5, RunStreamEventOneOf6, RunStreamEventOneOf7, RunStreamEventOneOf8, RunStreamEventOneOf9. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in RunStreamEvent with oneOf schemas: RunStreamEventOneOf, RunStreamEventOneOf1, RunStreamEventOneOf2, RunStreamEventOneOf3, RunStreamEventOneOf4, RunStreamEventOneOf5, RunStreamEventOneOf6, RunStreamEventOneOf7, RunStreamEventOneOf8, RunStreamEventOneOf9. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into RunStreamEventOneOf9
        try:
            instance.actual_instance = RunStreamEventOneOf9.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into RunStreamEvent with oneOf schemas: RunStreamEventOneOf, RunStreamEventOneOf1, RunStreamEventOneOf2, RunStreamEventOneOf3, RunStreamEventOneOf4, RunStreamEventOneOf5, RunStreamEventOneOf6, RunStreamEventOneOf7, RunStreamEventOneOf8, RunStreamEventOneOf9. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
