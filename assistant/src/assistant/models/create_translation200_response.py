...
from assistant.models.create_translation_response_json import CreateTranslationResponseJson
from assistant.models.create_translation_response_verbose_json import CreateTranslationResponseVerboseJson
...
class CreateTranslation200Response(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in CreateTranslation200Response with oneOf schemas: CreateTranslationResponseJson, CreateTranslationResponseVerboseJson. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in CreateTranslation200Response with oneOf schemas: CreateTranslationResponseJson, CreateTranslationResponseVerboseJson. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into CreateTranslation200Response with oneOf schemas: CreateTranslationResponseJson, CreateTranslationResponseVerboseJson. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into CreateTranslation200Response with oneOf schemas: CreateTranslationResponseJson, CreateTranslationResponseVerboseJson. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
