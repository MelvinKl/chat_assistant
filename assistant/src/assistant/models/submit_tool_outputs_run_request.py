...
from assistant.models.submit_tool_outputs_run_request_tool_outputs_inner import (
...
class SubmitToolOutputsRunRequest(BaseModel):
    ...
    tool_outputs: List[SubmitToolOutputsRunRequestToolOutputsInner] = Field(
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "tool_outputs": (
                    [SubmitToolOutputsRunRequestToolOutputsInner.from_dict(_item) for _item in obj.get("tool_outputs")]
                    if obj.get("tool_outputs") is not None
                    else None
                ),
