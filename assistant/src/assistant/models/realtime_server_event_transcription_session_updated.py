...
from assistant.models.realtime_transcription_session_create_response import RealtimeTranscriptionSessionCreateResponse
try:
...
class RealtimeServerEventTranscriptionSessionUpdated(BaseModel):
    ...
    type: StrictStr = Field(description="The event type, must be `transcription_session.updated`.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('transcription_session.updated',):
            raise ValueError("must be one of enum values ('transcription_session.updated')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "session": RealtimeTranscriptionSessionCreateResponse.from_dict(obj.get("session")) if obj.get("session") is not None else None
        })
        return _obj
