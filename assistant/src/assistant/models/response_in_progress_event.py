...
from assistant.models.response import Response
try:
...
class ResponseInProgressEvent(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the event. Always `response.in_progress`. ")
    response: Response
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('response.in_progress',):
            raise ValueError("must be one of enum values ('response.in_progress')")
        return value
