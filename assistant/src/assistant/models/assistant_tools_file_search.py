...
class AssistantToolsFileSearch(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of tool being defined: `file_search`")
    file_search: Optional[AssistantToolsFileSearchFileSearch] = None
    __properties: ClassVar[List[str]] = ["type", "file_search"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "file_search": AssistantToolsFileSearchFileSearch.from_dict(obj.get("file_search")) if obj.get("file_search") is not None else None
        })
        return _obj
