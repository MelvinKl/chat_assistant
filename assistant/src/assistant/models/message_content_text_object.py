...
from assistant.models.message_content_text_object_text import MessageContentTextObjectText
try:
...
class MessageContentTextObject(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "text": MessageContentTextObjectText.from_dict(obj.get("text")) if obj.get("text") is not None else None
        })
        return _obj
