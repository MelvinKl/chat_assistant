...
from assistant.models.create_chat_completion_response_choices_inner import CreateChatCompletionResponseChoicesInner
try:
...
class CreateChatCompletionResponse(BaseModel):
    ...
    service_tier: Optional[StrictStr] = Field(default=None, description="The service tier used for processing the request.")
    ...
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('chat.completion',):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "choices": [CreateChatCompletionResponseChoicesInner.from_dict(_item) for _item in obj.get("choices")] if obj.get("choices") is not None else None,
            "created": obj.get("created"),
            "model": obj.get("model"),
            "service_tier": obj.get("service_tier"),
            "system_fingerprint": obj.get("system_fingerprint"),
            "object": obj.get("object"),
            "usage": CompletionUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj
