...
class CreateChatCompletionResponse(BaseModel):
    ...
    choices: List[CreateChatCompletionResponseChoicesInner] = Field(
    ...
    service_tier: Optional[StrictStr] = Field(
        default=None, description="The service tier used for processing the request."
    )
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "choices": (
                    [CreateChatCompletionResponseChoicesInner.from_dict(_item) for _item in obj.get("choices")]
