...
class CreateUploadRequest(BaseModel):
    ...
    filename: StrictStr = Field(description="The name of the file to upload. ")
    ...
    bytes: StrictInt = Field(description="The number of bytes in the file you are uploading. ")
    ...
    __properties: ClassVar[List[str]] = ["filename", "purpose", "bytes", "mime_type"]
    ...
    def purpose_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError("must be one of enum values ('assistants', 'batch', 'fine-tune', 'vision')")
        return value
