...
from assistant.models.fine_tuning_job import FineTuningJob
try:
...
class ListPaginatedFineTuningJobsResponse(BaseModel):
    ...
    has_more: StrictBool
    object: StrictStr
    __properties: ClassVar[List[str]] = ["data", "has_more", "object"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [FineTuningJob.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
