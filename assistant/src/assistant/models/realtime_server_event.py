...
from assistant.models.realtime_server_event_conversation_item_input_audio_transcription_completed import RealtimeServerEventConversationItemInputAudioTranscriptionCompleted
from assistant.models.realtime_server_event_conversation_item_input_audio_transcription_delta import RealtimeServerEventConversationItemInputAudioTranscriptionDelta
from assistant.models.realtime_server_event_conversation_item_input_audio_transcription_failed import RealtimeServerEventConversationItemInputAudioTranscriptionFailed
from assistant.models.realtime_server_event_conversation_item_retrieved import RealtimeServerEventConversationItemRetrieved
from assistant.models.realtime_server_event_conversation_item_truncated import RealtimeServerEventConversationItemTruncated
...
from assistant.models.realtime_server_event_input_audio_buffer_committed import RealtimeServerEventInputAudioBufferCommitted
from assistant.models.realtime_server_event_input_audio_buffer_speech_started import RealtimeServerEventInputAudioBufferSpeechStarted
from assistant.models.realtime_server_event_input_audio_buffer_speech_stopped import RealtimeServerEventInputAudioBufferSpeechStopped
...
from assistant.models.realtime_server_event_response_audio_transcript_delta import RealtimeServerEventResponseAudioTranscriptDelta
from assistant.models.realtime_server_event_response_audio_transcript_done import RealtimeServerEventResponseAudioTranscriptDone
from assistant.models.realtime_server_event_response_content_part_added import RealtimeServerEventResponseContentPartAdded
...
from assistant.models.realtime_server_event_response_function_call_arguments_delta import RealtimeServerEventResponseFunctionCallArgumentsDelta
from assistant.models.realtime_server_event_response_function_call_arguments_done import RealtimeServerEventResponseFunctionCallArgumentsDone
...
from assistant.models.realtime_server_event_transcription_session_updated import RealtimeServerEventTranscriptionSessionUpdated
...
class RealtimeServerEvent(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[RealtimeServerEventConversationCreated, RealtimeServerEventConversationItemCreated, RealtimeServerEventConversationItemDeleted, RealtimeServerEventConversationItemInputAudioTranscriptionCompleted, RealtimeServerEventConversationItemInputAudioTranscriptionDelta, RealtimeServerEventConversationItemInputAudioTranscriptionFailed, RealtimeServerEventConversationItemRetrieved, RealtimeServerEventConversationItemTruncated, RealtimeServerEventError, RealtimeServerEventInputAudioBufferCleared, RealtimeServerEventInputAudioBufferCommitted, RealtimeServerEventInputAudioBufferSpeechStarted, RealtimeServerEventInputAudioBufferSpeechStopped, RealtimeServerEventRateLimitsUpdated, RealtimeServerEventResponseAudioDelta, RealtimeServerEventResponseAudioDone, RealtimeServerEventResponseAudioTranscriptDelta, RealtimeServerEventResponseAudioTranscriptDone, RealtimeServerEventResponseContentPartAdded, RealtimeServerEventResponseContentPartDone, RealtimeServerEventResponseCreated, RealtimeServerEventResponseDone, RealtimeServerEventResponseFunctionCallArgumentsDelta, RealtimeServerEventResponseFunctionCallArgumentsDone, RealtimeServerEventResponseOutputItemAdded, RealtimeServerEventResponseOutputItemDone, RealtimeServerEventResponseTextDelta, RealtimeServerEventResponseTextDone, RealtimeServerEventSessionCreated, RealtimeServerEventSessionUpdated, RealtimeServerEventTranscriptionSessionUpdated]] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, RealtimeServerEventConversationItemInputAudioTranscriptionCompleted):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventConversationItemInputAudioTranscriptionCompleted`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventConversationItemInputAudioTranscriptionDelta):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventConversationItemInputAudioTranscriptionDelta`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventConversationItemInputAudioTranscriptionFailed):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventConversationItemInputAudioTranscriptionFailed`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventConversationItemRetrieved):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventConversationItemRetrieved`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventConversationItemTruncated):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventConversationItemTruncated`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventInputAudioBufferCommitted):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventInputAudioBufferCommitted`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventInputAudioBufferSpeechStarted):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventInputAudioBufferSpeechStarted`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventInputAudioBufferSpeechStopped):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventInputAudioBufferSpeechStopped`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventResponseAudioTranscriptDelta):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventResponseAudioTranscriptDelta`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventResponseAudioTranscriptDone):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventResponseAudioTranscriptDone`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventResponseFunctionCallArgumentsDelta):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventResponseFunctionCallArgumentsDelta`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventResponseFunctionCallArgumentsDone):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventResponseFunctionCallArgumentsDone`")
        else:
            return v
        ...
        if not isinstance(v, RealtimeServerEventTranscriptionSessionUpdated):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RealtimeServerEventTranscriptionSessionUpdated`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in RealtimeServerEvent with anyOf schemas: RealtimeServerEventConversationCreated, RealtimeServerEventConversationItemCreated, RealtimeServerEventConversationItemDeleted, RealtimeServerEventConversationItemInputAudioTranscriptionCompleted, RealtimeServerEventConversationItemInputAudioTranscriptionDelta, RealtimeServerEventConversationItemInputAudioTranscriptionFailed, RealtimeServerEventConversationItemRetrieved, RealtimeServerEventConversationItemTruncated, RealtimeServerEventError, RealtimeServerEventInputAudioBufferCleared, RealtimeServerEventInputAudioBufferCommitted, RealtimeServerEventInputAudioBufferSpeechStarted, RealtimeServerEventInputAudioBufferSpeechStopped, RealtimeServerEventRateLimitsUpdated, RealtimeServerEventResponseAudioDelta, RealtimeServerEventResponseAudioDone, RealtimeServerEventResponseAudioTranscriptDelta, RealtimeServerEventResponseAudioTranscriptDone, RealtimeServerEventResponseContentPartAdded, RealtimeServerEventResponseContentPartDone, RealtimeServerEventResponseCreated, RealtimeServerEventResponseDone, RealtimeServerEventResponseFunctionCallArgumentsDelta, RealtimeServerEventResponseFunctionCallArgumentsDone, RealtimeServerEventResponseOutputItemAdded, RealtimeServerEventResponseOutputItemDone, RealtimeServerEventResponseTextDelta, RealtimeServerEventResponseTextDone, RealtimeServerEventSessionCreated, RealtimeServerEventSessionUpdated, RealtimeServerEventTranscriptionSessionUpdated. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_4_validator: Optional[RealtimeServerEventConversationItemInputAudioTranscriptionCompleted] = None
        try:
            instance.actual_instance = RealtimeServerEventConversationItemInputAudioTranscriptionCompleted.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[RealtimeServerEventConversationItemInputAudioTranscriptionDelta] = None
        try:
            instance.actual_instance = RealtimeServerEventConversationItemInputAudioTranscriptionDelta.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_6_validator: Optional[RealtimeServerEventConversationItemInputAudioTranscriptionFailed] = None
        try:
            instance.actual_instance = RealtimeServerEventConversationItemInputAudioTranscriptionFailed.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_7_validator: Optional[RealtimeServerEventConversationItemRetrieved] = None
