...
class UpdateVectorStoreRequestExpiresAfter(BaseModel):
    """
    ...
    days: Annotated[int, Field(le=365, strict=True, ge=1)] = Field(
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"anchor": obj.get("anchor"), "days": obj.get("days")})
        return _obj
