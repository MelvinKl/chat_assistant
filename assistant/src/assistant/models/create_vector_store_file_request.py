...
from assistant.models.chunking_strategy_request_param import ChunkingStrategyRequestParam
...
class CreateVectorStoreFileRequest(BaseModel):
    ...
    """ # noqa: E501
    file_id: StrictStr = Field(description="A [File](/docs/api-reference/files) ID that the vector store should use. Useful for tools like `file_search` that can access files.")
    chunking_strategy: Optional[ChunkingStrategyRequestParam] = None
    attributes: Optional[Dict[str, VectorStoreFileAttributesValue]] = Field(default=None, description="Set of 16 key-value pairs that can be attached to an object. This can be  useful for storing additional information about the object in a structured  format, and querying for objects via API or the dashboard. Keys are strings  with a maximum length of 64 characters. Values are strings with a maximum  length of 512 characters, booleans, or numbers. ")
    __properties: ClassVar[List[str]] = ["file_id", "chunking_strategy", "attributes"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "chunking_strategy": ChunkingStrategyRequestParam.from_dict(obj.get("chunking_strategy")) if obj.get("chunking_strategy") is not None else None,
            "attributes": dict(
