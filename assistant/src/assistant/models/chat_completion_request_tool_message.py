...
from assistant.models.chat_completion_request_tool_message_content import ChatCompletionRequestToolMessageContent
        ...
        _obj = cls.model_validate(
            {
                "role": obj.get("role"),
                "content": (
                    ChatCompletionRequestToolMessageContent.from_dict(obj.get("content"))
