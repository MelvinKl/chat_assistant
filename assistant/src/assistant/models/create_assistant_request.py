...
from assistant.models.create_assistant_request_model import CreateAssistantRequestModel
from assistant.models.create_assistant_request_tool_resources import CreateAssistantRequestToolResources
...
class CreateAssistantRequest(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(
        default=None, description="The name of the assistant. The maximum length is 256 characters. "
    )
    description: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(
        default=None, description="The description of the assistant. The maximum length is 512 characters. "
    )
    instructions: Optional[Annotated[str, Field(strict=True, max_length=256000)]] = Field(
        default=None,
    ...
    tools: Optional[Annotated[List[AssistantObjectToolsInner], Field(max_length=128)]] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "model": (
                    CreateAssistantRequestModel.from_dict(obj.get("model")) if obj.get("model") is not None else None
                ),
                "name": obj.get("name"),
                ...
                "tool_resources": (
                    CreateAssistantRequestToolResources.from_dict(obj.get("tool_resources"))
                    if obj.get("tool_resources") is not None
                    else None
                ),
