...
from assistant.models.transcription_word import TranscriptionWord
...
class CreateTranscriptionResponseVerboseJson(BaseModel):
    ...
    segments: Optional[List[TranscriptionSegment]] = Field(
        default=None, description="Segments of the transcribed text and their corresponding details."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "text": obj.get("text"),
                "words": (
                    [TranscriptionWord.from_dict(_item) for _item in obj.get("words")]
                    if obj.get("words") is not None
                    else None
                ),
                "segments": (
