...
from assistant.models.create_chat_completion_stream_response_choices_inner import (
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "choices": (
                    [CreateChatCompletionStreamResponseChoicesInner.from_dict(_item) for _item in obj.get("choices")]
