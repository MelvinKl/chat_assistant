...
class AuditLogInviteSentData(BaseModel):
    """
    The payload used to create the invite.
    """  # noqa: E501

    email: Optional[StrictStr] = Field(default=None, description="The email invited to the organization.")
    role: Optional[StrictStr] = Field(
        default=None, description="The role the email was invited to be. Is either `owner` or `member`."
    )
