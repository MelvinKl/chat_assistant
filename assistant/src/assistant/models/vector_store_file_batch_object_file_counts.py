...
class VectorStoreFileBatchObjectFileCounts(BaseModel):
    """
    ...
    completed: StrictInt = Field(description="The number of files that have been processed.")
    failed: StrictInt = Field(description="The number of files that have failed to process.")
    cancelled: StrictInt = Field(description="The number of files that where cancelled.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VectorStoreFileBatchObjectFileCounts from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of VectorStoreFileBatchObjectFileCounts from a dict"""
        if obj is None:
            return None
