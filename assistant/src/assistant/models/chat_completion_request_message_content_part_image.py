...
from assistant.models.chat_completion_request_message_content_part_image_image_url import (
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "image_url": (
                    ChatCompletionRequestMessageContentPartImageImageUrl.from_dict(obj.get("image_url"))
