...
class ChatCompletionRequestAssistantMessageAudio(BaseModel):
    """
    Data about a previous audio response from the model.  [Learn more](/docs/guides/audio).
    """  # noqa: E501

    id: StrictStr = Field(description="Unique identifier for a previous audio response from the model. ")
