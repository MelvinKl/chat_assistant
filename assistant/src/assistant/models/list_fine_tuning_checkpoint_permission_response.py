...
from assistant.models.fine_tuning_checkpoint_permission import FineTuningCheckpointPermission
try:
...
class ListFineTuningCheckpointPermissionResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [FineTuningCheckpointPermission.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
