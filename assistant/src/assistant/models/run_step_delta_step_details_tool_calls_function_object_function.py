...
class RunStepDeltaStepDetailsToolCallsFunctionObjectFunction(BaseModel):
    """
    The definition of the function that was called.
    """  # noqa: E501

    name: Optional[StrictStr] = Field(default=None, description="The name of the function.")
    arguments: Optional[StrictStr] = Field(default=None, description="The arguments passed to the function.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "arguments": obj.get("arguments"), "output": obj.get("output")}
        )
        return _obj
