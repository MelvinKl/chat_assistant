...
class CreateSpeechRequest(BaseModel):
    ...
    instructions: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Control the voice of your generated audio with additional instructions. Does not work with `tts-1` or `tts-1-hd`.")
    ...
    speed: Optional[Union[Annotated[float, Field(le=4, strict=True, ge=0.25)], Annotated[int, Field(le=4, strict=True, ge=1)]]] = Field(default=1, description="The speed of the generated audio. Select a value from `0.25` to `4.0`. `1.0` is the default.")
