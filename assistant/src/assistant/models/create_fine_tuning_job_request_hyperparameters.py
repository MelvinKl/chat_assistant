...
from assistant.models.create_fine_tuning_job_request_hyperparameters_learning_rate_multiplier import (
    CreateFineTuningJobRequestHyperparametersLearningRateMultiplier,
)
from assistant.models.create_fine_tuning_job_request_hyperparameters_n_epochs import (
...
class CreateFineTuningJobRequestHyperparameters(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "batch_size": (
                    CreateFineTuningJobRequestHyperparametersBatchSize.from_dict(obj.get("batch_size"))
                    if obj.get("batch_size") is not None
                    else None
                ),
                "learning_rate_multiplier": (
                    CreateFineTuningJobRequestHyperparametersLearningRateMultiplier.from_dict(
                ...
                "n_epochs": (
                    CreateFineTuningJobRequestHyperparametersNEpochs.from_dict(obj.get("n_epochs"))
