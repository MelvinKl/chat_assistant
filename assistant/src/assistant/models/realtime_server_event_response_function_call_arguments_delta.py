...
class RealtimeServerEventResponseFunctionCallArgumentsDelta(BaseModel):
    ...
    type: StrictStr = Field(description="The event type, must be `response.function_call_arguments.delta`. ")
    ...
    delta: StrictStr = Field(description="The arguments delta as a JSON string.")
    __properties: ClassVar[List[str]] = ["event_id", "type", "response_id", "item_id", "output_index", "call_id", "delta"]
