...
from assistant.models.fine_tune_chat_completion_request_assistant_message import FineTuneChatCompletionRequestAssistantMessage
...
FINETUNECHATREQUESTINPUTMESSAGESINNER_ONE_OF_SCHEMAS = ["ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage", "FineTuneChatCompletionRequestAssistantMessage"]

class FineTuneChatRequestInputMessagesInner(BaseModel):
    """
    ...
    # data type: FineTuneChatCompletionRequestAssistantMessage
    oneof_schema_3_validator: Optional[FineTuneChatCompletionRequestAssistantMessage] = None
    ...
    actual_instance: Optional[Union[ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage]] = None
    one_of_schemas: List[str] = Literal["ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage", "FineTuneChatCompletionRequestAssistantMessage"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = FineTuneChatRequestInputMessagesInner.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, ChatCompletionRequestUserMessage):
            ...
            match += 1
        # validate data type: FineTuneChatCompletionRequestAssistantMessage
        if not isinstance(v, FineTuneChatCompletionRequestAssistantMessage):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FineTuneChatCompletionRequestAssistantMessage`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in FineTuneChatRequestInputMessagesInner with oneOf schemas: ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in FineTuneChatRequestInputMessagesInner with oneOf schemas: ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into FineTuneChatCompletionRequestAssistantMessage
        try:
            instance.actual_instance = FineTuneChatCompletionRequestAssistantMessage.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into FineTuneChatRequestInputMessagesInner with oneOf schemas: ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
