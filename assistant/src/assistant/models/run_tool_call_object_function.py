...
class RunToolCallObjectFunction(BaseModel):
    """
    The function definition.
    """  # noqa: E501

    name: StrictStr = Field(description="The name of the function.")
    arguments: StrictStr = Field(description="The arguments that the model expects you to pass to the function.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "arguments": obj.get("arguments")})
        return _obj
