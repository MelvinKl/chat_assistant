...
class AuditLogUserUpdatedChangesRequested(BaseModel):
    """
    The payload used to update the user.
    """  # noqa: E501

    role: Optional[StrictStr] = Field(default=None, description="The role of the user. Is either `owner` or `member`.")
