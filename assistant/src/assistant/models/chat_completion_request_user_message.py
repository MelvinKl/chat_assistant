...
from assistant.models.chat_completion_request_user_message_content import ChatCompletionRequestUserMessageContent
try:
...
class ChatCompletionRequestUserMessage(BaseModel):
    ...
    role: StrictStr = Field(description="The role of the messages author, in this case `user`.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "content": ChatCompletionRequestUserMessageContent.from_dict(obj.get("content")) if obj.get("content") is not None else None,
            "role": obj.get("role"),
            "name": obj.get("name")
        })
        return _obj
