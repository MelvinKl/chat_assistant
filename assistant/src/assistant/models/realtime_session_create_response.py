...
from assistant.models.realtime_session_create_response_input_audio_transcription import RealtimeSessionCreateResponseInputAudioTranscription
...
class RealtimeSessionCreateResponse(BaseModel):
    ...
    input_audio_transcription: Optional[RealtimeSessionCreateResponseInputAudioTranscription] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "client_secret": RealtimeSessionCreateResponseClientSecret.from_dict(obj.get("client_secret")) if obj.get("client_secret") is not None else None,
            ...
            "input_audio_transcription": RealtimeSessionCreateResponseInputAudioTranscription.from_dict(obj.get("input_audio_transcription")) if obj.get("input_audio_transcription") is not None else None,
