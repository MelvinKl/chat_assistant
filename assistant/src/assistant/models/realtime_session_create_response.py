...
class RealtimeSessionCreateResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "client_secret": (
                    RealtimeSessionCreateResponseClientSecret.from_dict(obj.get("client_secret"))
                ...
                "input_audio_transcription": (
                    RealtimeSessionCreateResponseInputAudioTranscription.from_dict(obj.get("input_audio_transcription"))
