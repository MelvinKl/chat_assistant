...
class CreateChatCompletionResponseChoicesInnerLogprobs(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "content": (
                    [ChatCompletionTokenLogprob.from_dict(_item) for _item in obj.get("content")]
                    if obj.get("content") is not None
                    else None
                ),
                "refusal": (
                    [ChatCompletionTokenLogprob.from_dict(_item) for _item in obj.get("refusal")]
                    if obj.get("refusal") is not None
                    else None
                ),
            }
        )
