...
from assistant.models.run_step_delta_step_details_tool_calls_object_tool_calls_inner import (
...
class RunStepDeltaStepDetailsToolCallsObject(BaseModel):
    ...
    tool_calls: Optional[List[RunStepDeltaStepDetailsToolCallsObjectToolCallsInner]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "tool_calls": (
                    [
                        RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.from_dict(_item)
