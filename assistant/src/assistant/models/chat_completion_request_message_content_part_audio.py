...
from assistant.models.chat_completion_request_message_content_part_audio_input_audio import (
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "input_audio": (
                    ChatCompletionRequestMessageContentPartAudioInputAudio.from_dict(obj.get("input_audio"))
