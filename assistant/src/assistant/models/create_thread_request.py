...
class CreateThreadRequest(BaseModel):
    ...
    messages: Optional[List[CreateMessageRequest]] = Field(
        default=None, description="A list of [messages](/docs/api-reference/messages) to start the thread with."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "messages": (
                    [CreateMessageRequest.from_dict(_item) for _item in obj.get("messages")]
                    if obj.get("messages") is not None
                    else None
                ),
                "tool_resources": (
                    CreateThreadRequestToolResources.from_dict(obj.get("tool_resources"))
