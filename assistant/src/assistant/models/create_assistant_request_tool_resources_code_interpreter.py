...
class CreateAssistantRequestToolResourcesCodeInterpreter(BaseModel):
    """
    CreateAssistantRequestToolResourcesCodeInterpreter
    """  # noqa: E501

    file_ids: Optional[Annotated[List[StrictStr], Field(max_length=20)]] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"file_ids": obj.get("file_ids")})
        return _obj
