...
class CreateFineTuningJobRequest(BaseModel):
    ...
    suffix: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(
        default=None,
    ...
    integrations: Optional[List[CreateFineTuningJobRequestIntegrationsInner]] = Field(
        default=None, description="A list of integrations to enable for your fine-tuning job."
    )
    seed: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "model": (
                    CreateFineTuningJobRequestModel.from_dict(obj.get("model"))
                    if obj.get("model") is not None
                    else None
                ),
                "training_file": obj.get("training_file"),
                "hyperparameters": (
                    CreateFineTuningJobRequestHyperparameters.from_dict(obj.get("hyperparameters"))
                ...
                "integrations": (
                    [CreateFineTuningJobRequestIntegrationsInner.from_dict(_item) for _item in obj.get("integrations")]
