...
from assistant.models.create_fine_tuning_job_request_integrations_inner import CreateFineTuningJobRequestIntegrationsInner
...
class CreateFineTuningJobRequest(BaseModel):
    ...
    training_file: StrictStr = Field(description="The ID of an uploaded file that contains training data.  See [upload file](/docs/api-reference/files/create) for how to upload a file.  Your dataset must be formatted as a JSONL file. Additionally, you must upload your file with the purpose `fine-tune`.  The contents of the file should differ depending on if the model uses the [chat](/docs/api-reference/fine-tuning/chat-input), [completions](/docs/api-reference/fine-tuning/completions-input) format, or if the fine-tuning method uses the [preference](/docs/api-reference/fine-tuning/preference-input) format.  See the [fine-tuning guide](/docs/guides/fine-tuning) for more details. ")
    hyperparameters: Optional[CreateFineTuningJobRequestHyperparameters] = None
    suffix: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="A string of up to 64 characters that will be added to your fine-tuned model name.  For example, a `suffix` of \"custom-model-name\" would produce a model name like `ft:gpt-4o-mini:openai:custom-model-name:7p4lURel`. ")
    ...
    __properties: ClassVar[List[str]] = ["model", "training_file", "hyperparameters", "suffix", "validation_file", "integrations", "seed", "method", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "integrations": [CreateFineTuningJobRequestIntegrationsInner.from_dict(_item) for _item in obj.get("integrations")] if obj.get("integrations") is not None else None,
            "seed": obj.get("seed"),
            "method": FineTuneMethod.from_dict(obj.get("method")) if obj.get("method") is not None else None,
