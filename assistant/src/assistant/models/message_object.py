...
class MessageObject(BaseModel):
    ...
    incomplete_at: Optional[StrictInt] = Field(
    ...
    content: List[MessageObjectContentInner] = Field(
        description="The content of the message in array of text and/or images."
    )
    assistant_id: Optional[StrictStr] = Field(
    ...
    attachments: Optional[List[CreateMessageRequestAttachmentsInner]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "incomplete_details": (
                    MessageObjectIncompleteDetails.from_dict(obj.get("incomplete_details"))
                ...
                "role": obj.get("role"),
                "content": (
                    [MessageObjectContentInner.from_dict(_item) for _item in obj.get("content")]
                ...
                "attachments": (
                    [CreateMessageRequestAttachmentsInner.from_dict(_item) for _item in obj.get("attachments")]
