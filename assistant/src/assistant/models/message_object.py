...
class MessageObject(BaseModel):
    ...
    attachments: Optional[List[CreateMessageRequestAttachmentsInner]] = Field(description="A list of files attached to the message, and the tools they were added to.")
