...
from assistant.models.realtime_transcription_session_create_request import RealtimeTranscriptionSessionCreateRequest
...
class RealtimeClientEventTranscriptionSessionUpdate(BaseModel):
    ...
    event_id: Optional[StrictStr] = Field(
        default=None, description="Optional client-generated ID used to identify this event."
    )
    type: StrictStr = Field(description="The event type, must be `transcription_session.update`.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("transcription_session.update",):
            raise ValueError("must be one of enum values ('transcription_session.update')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "session": (
                    RealtimeTranscriptionSessionCreateRequest.from_dict(obj.get("session"))
