...
class ModifyAssistantRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["model", "reasoning_effort", "name", "description", "instructions", "tools", "tool_resources", "metadata", "temperature", "top_p", "response_format"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "model": ModifyAssistantRequestModel.from_dict(obj.get("model")) if obj.get("model") is not None else None,
            ...
            "tool_resources": ModifyAssistantRequestToolResources.from_dict(obj.get("tool_resources")) if obj.get("tool_resources") is not None else None,
