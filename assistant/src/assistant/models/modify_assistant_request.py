...
from assistant.models.modify_assistant_request_model import ModifyAssistantRequestModel
from assistant.models.modify_assistant_request_tool_resources import ModifyAssistantRequestToolResources
...
class ModifyAssistantRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "model": (
                    ModifyAssistantRequestModel.from_dict(obj.get("model")) if obj.get("model") is not None else None
                ),
                "reasoning_effort": (
                ...
                "tool_resources": (
                    ModifyAssistantRequestToolResources.from_dict(obj.get("tool_resources"))
