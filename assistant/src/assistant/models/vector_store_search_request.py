...
class VectorStoreSearchRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "query": VectorStoreSearchRequestQuery.from_dict(obj.get("query")) if obj.get("query") is not None else None,
            ...
            "ranking_options": VectorStoreSearchRequestRankingOptions.from_dict(obj.get("ranking_options")) if obj.get("ranking_options") is not None else None
        })
        return _obj
