...
from assistant.models.done_event import DoneEvent
from assistant.models.error_event import ErrorEvent
from assistant.models.message_stream_event import MessageStreamEvent
from assistant.models.run_step_stream_event import RunStepStreamEvent
from assistant.models.run_stream_event import RunStreamEvent
from assistant.models.thread_stream_event import ThreadStreamEvent
...
ASSISTANTSTREAMEVENT_ONE_OF_SCHEMAS = [
    "DoneEvent",
    "ErrorEvent",
    "MessageStreamEvent",
    "RunStepStreamEvent",
...
class AssistantStreamEvent(BaseModel):
    ...
    actual_instance: Optional[
        Union[DoneEvent, ErrorEvent, MessageStreamEvent, RunStepStreamEvent, RunStreamEvent, ThreadStreamEvent]
    ] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in AssistantStreamEvent with oneOf schemas: DoneEvent, ErrorEvent, MessageStreamEvent, RunStepStreamEvent, RunStreamEvent, ThreadStreamEvent. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in AssistantStreamEvent with oneOf schemas: DoneEvent, ErrorEvent, MessageStreamEvent, RunStepStreamEvent, RunStreamEvent, ThreadStreamEvent. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into AssistantStreamEvent with oneOf schemas: DoneEvent, ErrorEvent, MessageStreamEvent, RunStepStreamEvent, RunStreamEvent, ThreadStreamEvent. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into AssistantStreamEvent with oneOf schemas: DoneEvent, ErrorEvent, MessageStreamEvent, RunStepStreamEvent, RunStreamEvent, ThreadStreamEvent. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
