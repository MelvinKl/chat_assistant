...
from assistant.models.message_content_text_annotations_file_path_object_file_path import (
        ...
        _obj = cls.model_validate(
            {
                ...
                "text": obj.get("text"),
                "file_path": (
                    MessageContentTextAnnotationsFilePathObjectFilePath.from_dict(obj.get("file_path"))
