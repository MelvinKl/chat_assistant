...
from assistant.models.realtime_transcription_session_create_response_client_secret import RealtimeTranscriptionSessionCreateResponseClientSecret
from assistant.models.realtime_transcription_session_create_response_input_audio_transcription import RealtimeTranscriptionSessionCreateResponseInputAudioTranscription
try:
...
class RealtimeTranscriptionSessionCreateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_secret", "modalities", "input_audio_format", "input_audio_transcription", "turn_detection"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "client_secret": RealtimeTranscriptionSessionCreateResponseClientSecret.from_dict(obj.get("client_secret")) if obj.get("client_secret") is not None else None,
            "modalities": obj.get("modalities"),
            "input_audio_format": obj.get("input_audio_format"),
            "input_audio_transcription": RealtimeTranscriptionSessionCreateResponseInputAudioTranscription.from_dict(obj.get("input_audio_transcription")) if obj.get("input_audio_transcription") is not None else None,
            "turn_detection": RealtimeSessionCreateResponseTurnDetection.from_dict(obj.get("turn_detection")) if obj.get("turn_detection") is not None else None
        })
        return _obj
