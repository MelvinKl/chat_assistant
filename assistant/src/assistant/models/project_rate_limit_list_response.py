...
from assistant.models.project_rate_limit import ProjectRateLimit
try:
...
class ProjectRateLimitListResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ProjectRateLimit.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
