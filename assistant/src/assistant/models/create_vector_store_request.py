...
from assistant.models.create_vector_store_request_chunking_strategy import CreateVectorStoreRequestChunkingStrategy
...
class CreateVectorStoreRequest(BaseModel):
    ...
    file_ids: Optional[Annotated[List[StrictStr], Field(max_length=500)]] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["file_ids", "name", "expires_after", "chunking_strategy", "metadata"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "expires_after": (
                    VectorStoreExpirationAfter.from_dict(obj.get("expires_after"))
                    if obj.get("expires_after") is not None
                    else None
                ),
                "chunking_strategy": (
                    CreateVectorStoreRequestChunkingStrategy.from_dict(obj.get("chunking_strategy"))
