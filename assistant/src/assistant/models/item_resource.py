...
ITEMRESOURCE_ONE_OF_SCHEMAS = ["ComputerToolCall", "ComputerToolCallOutputResource", "FileSearchToolCall", "FunctionToolCallOutputResource", "FunctionToolCallResource", "InputMessageResource", "OutputMessage", "WebSearchToolCall"]
...
class ItemResource(BaseModel):
    ...
    actual_instance: Optional[Union[ComputerToolCall, ComputerToolCallOutputResource, FileSearchToolCall, FunctionToolCallOutputResource, FunctionToolCallResource, InputMessageResource, OutputMessage, WebSearchToolCall]] = None
    one_of_schemas: List[str] = Literal["ComputerToolCall", "ComputerToolCallOutputResource", "FileSearchToolCall", "FunctionToolCallOutputResource", "FunctionToolCallResource", "InputMessageResource", "OutputMessage", "WebSearchToolCall"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ItemResource with oneOf schemas: ComputerToolCall, ComputerToolCallOutputResource, FileSearchToolCall, FunctionToolCallOutputResource, FunctionToolCallResource, InputMessageResource, OutputMessage, WebSearchToolCall. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ItemResource with oneOf schemas: ComputerToolCall, ComputerToolCallOutputResource, FileSearchToolCall, FunctionToolCallOutputResource, FunctionToolCallResource, InputMessageResource, OutputMessage, WebSearchToolCall. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ItemResource with oneOf schemas: ComputerToolCall, ComputerToolCallOutputResource, FileSearchToolCall, FunctionToolCallOutputResource, FunctionToolCallResource, InputMessageResource, OutputMessage, WebSearchToolCall. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
