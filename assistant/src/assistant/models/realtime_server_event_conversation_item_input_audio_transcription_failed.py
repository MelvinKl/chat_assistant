...
from assistant.models.realtime_server_event_conversation_item_input_audio_transcription_failed_error import (
...
class RealtimeServerEventConversationItemInputAudioTranscriptionFailed(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("conversation.item.input_audio_transcription.failed",):
            raise ValueError("must be one of enum values ('conversation.item.input_audio_transcription.failed')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "error": (
                    RealtimeServerEventConversationItemInputAudioTranscriptionFailedError.from_dict(obj.get("error"))
