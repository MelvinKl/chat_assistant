...
class UsageCompletionsResult(BaseModel):
    ...
    input_cached_tokens: Optional[StrictInt] = Field(
        default=None,
    ...
    input_audio_tokens: Optional[StrictInt] = Field(
        default=None, description="The aggregated number of audio input tokens used, including cached tokens."
    )
    output_audio_tokens: Optional[StrictInt] = Field(
        default=None, description="The aggregated number of audio output tokens used."
    )
    ...
    batch: Optional[StrictBool] = Field(
        default=None,
    ...
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("organization.usage.completions.result",):
