...
from assistant.models.realtime_session import RealtimeSession
...
class RealtimeServerEventSessionCreated(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("session.created",):
            raise ValueError("must be one of enum values ('session.created')")
        return value
