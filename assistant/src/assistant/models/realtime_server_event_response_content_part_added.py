...
from assistant.models.realtime_server_event_response_content_part_added_part import (
        ...
        _obj = cls.model_validate(
            {
                ...
                "part": (
                    RealtimeServerEventResponseContentPartAddedPart.from_dict(obj.get("part"))
