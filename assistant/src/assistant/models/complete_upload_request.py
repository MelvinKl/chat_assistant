...
class CompleteUploadRequest(BaseModel):
    ...
    part_ids: List[StrictStr] = Field(description="The ordered list of Part IDs. ")
    ...
    __properties: ClassVar[List[str]] = ["part_ids", "md5"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"part_ids": obj.get("part_ids"), "md5": obj.get("md5")})
        return _obj
