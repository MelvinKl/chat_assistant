...
from assistant.models.audit_log_api_key_updated import AuditLogApiKeyUpdated
from assistant.models.audit_log_event_type import AuditLogEventType
from assistant.models.audit_log_invite_accepted import AuditLogInviteAccepted
from assistant.models.audit_log_invite_sent import AuditLogInviteSent
from assistant.models.audit_log_login_failed import AuditLogLoginFailed
from assistant.models.audit_log_organization_updated import AuditLogOrganizationUpdated
from assistant.models.audit_log_project import AuditLogProject
from assistant.models.audit_log_project_archived import AuditLogProjectArchived
from assistant.models.audit_log_project_created import AuditLogProjectCreated
...
class AuditLog(BaseModel):
    ...
    service_account_created: Optional[AuditLogServiceAccountCreated] = Field(
        default=None, alias="service_account.created"
    )
    service_account_updated: Optional[AuditLogServiceAccountUpdated] = Field(
        default=None, alias="service_account.updated"
    )
    service_account_deleted: Optional[AuditLogServiceAccountDeleted] = Field(
        default=None, alias="service_account.deleted"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "api_key.created": (
                    AuditLogApiKeyCreated.from_dict(obj.get("api_key.created"))
                    if obj.get("api_key.created") is not None
                    else None
                ),
                "api_key.updated": (
                    AuditLogApiKeyUpdated.from_dict(obj.get("api_key.updated"))
                    if obj.get("api_key.updated") is not None
                    else None
                ),
                "api_key.deleted": (
                    AuditLogApiKeyDeleted.from_dict(obj.get("api_key.deleted"))
                    if obj.get("api_key.deleted") is not None
                    else None
                ),
                "invite.sent": (
                    AuditLogInviteSent.from_dict(obj.get("invite.sent")) if obj.get("invite.sent") is not None else None
                ),
                "invite.accepted": (
                    AuditLogInviteAccepted.from_dict(obj.get("invite.accepted"))
                    if obj.get("invite.accepted") is not None
                    else None
                ),
                "invite.deleted": (
                    AuditLogInviteAccepted.from_dict(obj.get("invite.deleted"))
                    if obj.get("invite.deleted") is not None
                    else None
                ),
                "login.failed": (
                    AuditLogLoginFailed.from_dict(obj.get("login.failed"))
                    if obj.get("login.failed") is not None
                    else None
                ),
                "logout.failed": (
                    AuditLogLoginFailed.from_dict(obj.get("logout.failed"))
                    if obj.get("logout.failed") is not None
                    else None
                ),
                "organization.updated": (
                    AuditLogOrganizationUpdated.from_dict(obj.get("organization.updated"))
                    if obj.get("organization.updated") is not None
                    else None
                ),
                "project.created": (
                    AuditLogProjectCreated.from_dict(obj.get("project.created"))
                    if obj.get("project.created") is not None
                    else None
                ),
                "project.updated": (
                    AuditLogProjectUpdated.from_dict(obj.get("project.updated"))
                    if obj.get("project.updated") is not None
                    else None
                ),
                "project.archived": (
                    AuditLogProjectArchived.from_dict(obj.get("project.archived"))
                    if obj.get("project.archived") is not None
                    else None
                ),
                "rate_limit.updated": (
                    AuditLogRateLimitUpdated.from_dict(obj.get("rate_limit.updated"))
                    if obj.get("rate_limit.updated") is not None
                    else None
                ),
                "rate_limit.deleted": (
                    AuditLogRateLimitDeleted.from_dict(obj.get("rate_limit.deleted"))
                    if obj.get("rate_limit.deleted") is not None
                    else None
                ),
                "service_account.created": (
                    AuditLogServiceAccountCreated.from_dict(obj.get("service_account.created"))
                    if obj.get("service_account.created") is not None
                    else None
                ),
                "service_account.updated": (
                    AuditLogServiceAccountUpdated.from_dict(obj.get("service_account.updated"))
                    if obj.get("service_account.updated") is not None
                    else None
                ),
                "service_account.deleted": (
                    AuditLogServiceAccountDeleted.from_dict(obj.get("service_account.deleted"))
                    if obj.get("service_account.deleted") is not None
                    else None
                ),
                "user.added": (
                    AuditLogUserAdded.from_dict(obj.get("user.added")) if obj.get("user.added") is not None else None
                ),
                "user.updated": (
                    AuditLogUserUpdated.from_dict(obj.get("user.updated"))
                    if obj.get("user.updated") is not None
                    else None
                ),
                "user.deleted": (
                    AuditLogUserDeleted.from_dict(obj.get("user.deleted"))
                    if obj.get("user.deleted") is not None
                    else None
                ),
            }
        )
