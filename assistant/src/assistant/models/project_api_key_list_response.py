...
from assistant.models.project_api_key import ProjectApiKey
try:
...
class ProjectApiKeyListResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ProjectApiKey.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
