...
class RealtimeResponseUsage(BaseModel):
    ...
    input_tokens: Optional[StrictInt] = Field(
        default=None, description="The number of input tokens used in the Response, including text and  audio tokens. "
    )
    output_tokens: Optional[StrictInt] = Field(
        default=None, description="The number of output tokens sent in the Response, including text and  audio tokens. "
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "input_token_details": (
                    RealtimeResponseUsageInputTokenDetails.from_dict(obj.get("input_token_details"))
                    if obj.get("input_token_details") is not None
                    else None
                ),
                "output_token_details": (
                    RealtimeResponseUsageOutputTokenDetails.from_dict(obj.get("output_token_details"))
                    if obj.get("output_token_details") is not None
                    else None
                ),
            }
        )
