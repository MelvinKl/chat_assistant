...
from assistant.models.vector_store_object import VectorStoreObject
try:
...
class ListVectorStoresResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [VectorStoreObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
