...
class RealtimeSessionCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["modalities", "model", "instructions", "voice", "input_audio_format", "output_audio_format", "input_audio_transcription", "turn_detection", "input_audio_noise_reduction", "tools", "tool_choice", "temperature", "max_response_output_tokens"]
