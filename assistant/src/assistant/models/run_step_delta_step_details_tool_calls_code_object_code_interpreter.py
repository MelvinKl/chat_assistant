...
from assistant.models.run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner import (
...
class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter(BaseModel):
    ...
    outputs: Optional[List[RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "outputs": (
                    [
                        RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner.from_dict(_item)
