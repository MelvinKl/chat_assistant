...
class CompletionUsagePromptTokensDetails(BaseModel):
    """
    Breakdown of tokens used in the prompt.
    """  # noqa: E501

    audio_tokens: Optional[StrictInt] = Field(default=0, description="Audio input tokens present in the prompt.")
    cached_tokens: Optional[StrictInt] = Field(default=0, description="Cached tokens present in the prompt.")
