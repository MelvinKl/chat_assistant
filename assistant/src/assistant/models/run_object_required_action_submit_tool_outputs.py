...
from assistant.models.run_tool_call_object import RunToolCallObject
try:
...
class RunObjectRequiredActionSubmitToolOutputs(BaseModel):
    ...
    """ # noqa: E501
    tool_calls: List[RunToolCallObject] = Field(description="A list of the relevant tool calls.")
    __properties: ClassVar[List[str]] = ["tool_calls"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tool_calls": [RunToolCallObject.from_dict(_item) for _item in obj.get("tool_calls")] if obj.get("tool_calls") is not None else None
        })
        return _obj
