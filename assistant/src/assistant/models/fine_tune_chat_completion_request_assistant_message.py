...
from assistant.models.chat_completion_request_assistant_message_audio import ChatCompletionRequestAssistantMessageAudio
from assistant.models.chat_completion_request_assistant_message_content import (
    ChatCompletionRequestAssistantMessageContent,
)
from assistant.models.chat_completion_request_assistant_message_function_call import (
...
class FineTuneChatCompletionRequestAssistantMessage(BaseModel):
    ...
    weight: Optional[StrictInt] = Field(
        default=None, description="Controls whether the assistant message is trained against (0 or 1)"
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "content": (
                    ChatCompletionRequestAssistantMessageContent.from_dict(obj.get("content"))
                ...
                "name": obj.get("name"),
                "audio": (
                    ChatCompletionRequestAssistantMessageAudio.from_dict(obj.get("audio"))
                ...
                "function_call": (
                    ChatCompletionRequestAssistantMessageFunctionCall.from_dict(obj.get("function_call"))
