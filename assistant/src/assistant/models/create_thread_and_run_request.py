...
class CreateThreadAndRunRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assistant_id", "thread", "model", "instructions", "tools", "tool_resources", "metadata", "temperature", "top_p", "stream", "max_prompt_tokens", "max_completion_tokens", "truncation_strategy", "tool_choice", "parallel_tool_calls", "response_format"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "model": CreateThreadAndRunRequestModel.from_dict(obj.get("model")) if obj.get("model") is not None else None,
