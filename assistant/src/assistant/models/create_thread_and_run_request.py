...
class CreateThreadAndRunRequest(BaseModel):
    ...
    tools: Optional[Annotated[List[CreateThreadAndRunRequestToolsInner], Field(max_length=20)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "model": (
                    CreateThreadAndRunRequestModel.from_dict(obj.get("model")) if obj.get("model") is not None else None
                ),
                "instructions": obj.get("instructions"),
                "tools": (
                    [CreateThreadAndRunRequestToolsInner.from_dict(_item) for _item in obj.get("tools")]
                    if obj.get("tools") is not None
                    else None
                ),
                "tool_resources": (
                    CreateThreadAndRunRequestToolResources.from_dict(obj.get("tool_resources"))
