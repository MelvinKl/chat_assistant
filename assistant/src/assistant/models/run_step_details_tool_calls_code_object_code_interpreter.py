...
from assistant.models.run_step_details_tool_calls_code_object_code_interpreter_outputs_inner import (
...
class RunStepDetailsToolCallsCodeObjectCodeInterpreter(BaseModel):
    ...
    outputs: List[RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "outputs": (
                    [
                        RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner.from_dict(_item)
