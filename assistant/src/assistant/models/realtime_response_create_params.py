...
from assistant.models.realtime_conversation_item_with_reference import RealtimeConversationItemWithReference
from assistant.models.realtime_response_create_params_conversation import RealtimeResponseCreateParamsConversation
...
class RealtimeResponseCreateParams(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "conversation": RealtimeResponseCreateParamsConversation.from_dict(obj.get("conversation")) if obj.get("conversation") is not None else None,
            "metadata": obj.get("metadata"),
            "input": [RealtimeConversationItemWithReference.from_dict(_item) for _item in obj.get("input")] if obj.get("input") is not None else None
        })
        return _obj
