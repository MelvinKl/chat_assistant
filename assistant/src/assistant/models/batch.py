...
from assistant.models.batch_errors import BatchErrors
from assistant.models.batch_request_counts import BatchRequestCounts
...
class Batch(BaseModel):
    ...
    output_file_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the file containing the outputs of successfully executed requests."
    )
    error_file_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the file containing the outputs of requests with errors."
    )
    created_at: StrictInt = Field(description="The Unix timestamp (in seconds) for when the batch was created.")
    in_progress_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch started processing."
    )
    expires_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch will expire."
    )
    finalizing_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch started finalizing."
    )
    completed_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch was completed."
    )
    failed_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch failed."
    )
    expired_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch expired."
    )
    cancelling_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch started cancelling."
    )
    cancelled_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the batch was cancelled."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "request_counts": (
                    BatchRequestCounts.from_dict(obj.get("request_counts"))
                    if obj.get("request_counts") is not None
                    else None
                ),
