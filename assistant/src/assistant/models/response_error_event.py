...
class ResponseErrorEvent(BaseModel):
    ...
    type: StrictStr = Field(description="The type of the event. Always `error`. ")
    code: Optional[StrictStr] = Field(description="The error code. ")
    message: StrictStr = Field(description="The error message. ")
    param: Optional[StrictStr] = Field(description="The error parameter. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"type": obj.get("type"), "code": obj.get("code"), "message": obj.get("message"), "param": obj.get("param")}
        )
        return _obj
