...
from assistant.models.chat_completion_message_tool_call_function import ChatCompletionMessageToolCallFunction
try:
...
class ChatCompletionMessageToolCall(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "function": ChatCompletionMessageToolCallFunction.from_dict(obj.get("function")) if obj.get("function") is not None else None
        })
        return _obj
