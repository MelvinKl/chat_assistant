...
class ResponseContentPartDoneEvent(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the event. Always `response.content_part.done`. ")
    ...
    content_index: StrictInt = Field(description="The index of the content part that is done. ")
    part: OutputContent
