...
class RealtimeSessionTurnDetection(BaseModel):
    ...
    eagerness: Optional[StrictStr] = Field(
        default="auto",
    ...
    prefix_padding_ms: Optional[StrictInt] = Field(
        default=None,
    ...
    silence_duration_ms: Optional[StrictInt] = Field(
        default=None,
    ...
    create_response: Optional[StrictBool] = Field(
        default=True, description="Whether or not to automatically generate a response when a VAD stop event occurs. "
    )
    interrupt_response: Optional[StrictBool] = Field(
        default=True,
        ...
        _obj = cls.model_validate(
            {
                ...
                "interrupt_response": (
                    obj.get("interrupt_response") if obj.get("interrupt_response") is not None else True
                ),
            }
        )
        return _obj
