...
class ResponseIncompleteEvent(BaseModel):
    ...
    type: StrictStr = Field(description="The type of the event. Always `response.incomplete`. ")
    response: Response
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("response.incomplete",):
            raise ValueError("must be one of enum values ('response.incomplete')")
        return value
