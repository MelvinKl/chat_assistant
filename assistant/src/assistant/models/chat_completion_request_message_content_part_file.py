...
from assistant.models.chat_completion_request_message_content_part_file_file import (
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "file": (
                    ChatCompletionRequestMessageContentPartFileFile.from_dict(obj.get("file"))
