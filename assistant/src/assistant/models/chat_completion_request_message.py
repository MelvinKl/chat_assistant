...
CHATCOMPLETIONREQUESTMESSAGE_ONE_OF_SCHEMAS = ["ChatCompletionRequestAssistantMessage", "ChatCompletionRequestDeveloperMessage", "ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage"]

class ChatCompletionRequestMessage(BaseModel):
    """
    ChatCompletionRequestMessage
    """
    # data type: ChatCompletionRequestDeveloperMessage
    oneof_schema_1_validator: Optional[ChatCompletionRequestDeveloperMessage] = None
    # data type: ChatCompletionRequestSystemMessage
    oneof_schema_2_validator: Optional[ChatCompletionRequestSystemMessage] = None
    # data type: ChatCompletionRequestUserMessage
    oneof_schema_3_validator: Optional[ChatCompletionRequestUserMessage] = None
    # data type: ChatCompletionRequestAssistantMessage
    oneof_schema_4_validator: Optional[ChatCompletionRequestAssistantMessage] = None
    # data type: ChatCompletionRequestToolMessage
    oneof_schema_5_validator: Optional[ChatCompletionRequestToolMessage] = None
    # data type: ChatCompletionRequestFunctionMessage
    oneof_schema_6_validator: Optional[ChatCompletionRequestFunctionMessage] = None
    actual_instance: Optional[Union[ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage]] = None
    one_of_schemas: List[str] = Literal["ChatCompletionRequestAssistantMessage", "ChatCompletionRequestDeveloperMessage", "ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        error_messages = []
        match = 0
        # validate data type: ChatCompletionRequestDeveloperMessage
        if not isinstance(v, ChatCompletionRequestDeveloperMessage):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ChatCompletionRequestDeveloperMessage`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ChatCompletionRequestMessage with oneOf schemas: ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ChatCompletionRequestMessage with oneOf schemas: ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into ChatCompletionRequestDeveloperMessage
        try:
            instance.actual_instance = ChatCompletionRequestDeveloperMessage.from_json(json_str)
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ChatCompletionRequestMessage with oneOf schemas: ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
