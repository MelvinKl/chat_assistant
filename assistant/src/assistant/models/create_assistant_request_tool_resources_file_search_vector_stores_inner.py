...
from assistant.models.create_assistant_request_tool_resources_file_search_vector_stores_inner_chunking_strategy import (
...
class CreateAssistantRequestToolResourcesFileSearchVectorStoresInner(BaseModel):
    ...
    file_ids: Optional[Annotated[List[StrictStr], Field(max_length=10000)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "chunking_strategy": (
                    CreateAssistantRequestToolResourcesFileSearchVectorStoresInnerChunkingStrategy.from_dict(
                        obj.get("chunking_strategy")
                    )
