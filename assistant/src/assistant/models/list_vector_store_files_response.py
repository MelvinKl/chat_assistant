...
from assistant.models.vector_store_file_object import VectorStoreFileObject
try:
...
class ListVectorStoreFilesResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [VectorStoreFileObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
