...
class RealtimeConversationItemWithReference(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="For an item of type (`message` | `function_call` | `function_call_output`) this field allows the client to assign the unique ID of the item. It is not required because the server will generate one if not provided.  For an item of type `item_reference`, this field is required and is a reference to any item that has previously existed in the conversation. ")
    type: Optional[StrictStr] = Field(default=None, description="The type of the item (`message`, `function_call`, `function_call_output`, `item_reference`). ")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('message', 'function_call', 'function_call_output',):
