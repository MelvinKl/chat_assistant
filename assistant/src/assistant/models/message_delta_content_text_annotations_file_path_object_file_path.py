...
class MessageDeltaContentTextAnnotationsFilePathObjectFilePath(BaseModel):
    """
    MessageDeltaContentTextAnnotationsFilePathObjectFilePath
    """  # noqa: E501

    file_id: Optional[StrictStr] = Field(default=None, description="The ID of the file that was generated.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"file_id": obj.get("file_id")})
        return _obj
