...
from assistant.models.run_step_completion_usage import RunStepCompletionUsage
from assistant.models.run_step_object_last_error import RunStepObjectLastError
from assistant.models.run_step_object_step_details import RunStepObjectStepDetails
...
class RunStepObject(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('in_progress', 'cancelled', 'failed', 'completed', 'expired')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "step_details": (
                    RunStepObjectStepDetails.from_dict(obj.get("step_details"))
                    if obj.get("step_details") is not None
                    else None
                ),
                "last_error": (
                    RunStepObjectLastError.from_dict(obj.get("last_error"))
                    if obj.get("last_error") is not None
                    else None
                ),
