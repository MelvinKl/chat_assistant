...
class ChatCompletionMessageToolCallChunk(BaseModel):
    ...
    type: Optional[StrictStr] = Field(
        default=None, description="The type of the tool. Currently, only `function` is supported."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "function": (
                    ChatCompletionMessageToolCallChunkFunction.from_dict(obj.get("function"))
