...
from assistant.models.chat_completion_stream_response_delta import ChatCompletionStreamResponseDelta
from assistant.models.create_chat_completion_response_choices_inner_logprobs import (
...
class CreateChatCompletionStreamResponseChoicesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "delta": (
                    ChatCompletionStreamResponseDelta.from_dict(obj.get("delta"))
                    if obj.get("delta") is not None
                    else None
                ),
                "logprobs": (
                    CreateChatCompletionResponseChoicesInnerLogprobs.from_dict(obj.get("logprobs"))
