...
class AuditLogProjectUpdatedChangesRequested(BaseModel):
    """
    The payload used to update the project.
    """  # noqa: E501

    title: Optional[StrictStr] = Field(default=None, description="The title of the project as seen on the dashboard.")
