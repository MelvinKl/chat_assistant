...
class CreateModerationResponseResultsInnerCategoryAppliedInputTypes(BaseModel):
    ...
    hate_threatening: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'hate/threatening'.", alias="hate/threatening"
    )
    harassment: List[StrictStr] = Field(description="The applied input type(s) for the category 'harassment'.")
    harassment_threatening: List[StrictStr] = Field(
    ...
    illicit_violent: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'illicit/violent'.", alias="illicit/violent"
    )
    self_harm: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'self-harm'.", alias="self-harm"
    )
    self_harm_intent: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'self-harm/intent'.", alias="self-harm/intent"
    )
    self_harm_instructions: List[StrictStr] = Field(
    ...
    sexual_minors: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'sexual/minors'.", alias="sexual/minors"
    )
    violence: List[StrictStr] = Field(description="The applied input type(s) for the category 'violence'.")
    violence_graphic: List[StrictStr] = Field(
        description="The applied input type(s) for the category 'violence/graphic'.", alias="violence/graphic"
    )
