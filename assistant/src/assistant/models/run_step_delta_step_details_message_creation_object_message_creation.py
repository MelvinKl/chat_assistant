...
class RunStepDeltaStepDetailsMessageCreationObjectMessageCreation(BaseModel):
    """
    RunStepDeltaStepDetailsMessageCreationObjectMessageCreation
    """  # noqa: E501

    message_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the message that was created by this run step."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"message_id": obj.get("message_id")})
        return _obj
