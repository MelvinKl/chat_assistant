...
from assistant.models.run_step_details_tool_calls_file_search_result_object_content_inner import RunStepDetailsToolCallsFileSearchResultObjectContentInner
try:
