...
class RunStepDetailsToolCallsFileSearchResultObject(BaseModel):
    ...
    score: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = (
        Field(description="The score of the result. All values must be a floating point number between 0 and 1.")
    )
    content: Optional[List[RunStepDetailsToolCallsFileSearchResultObjectContentInner]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "content": (
                    [
                        RunStepDetailsToolCallsFileSearchResultObjectContentInner.from_dict(_item)
