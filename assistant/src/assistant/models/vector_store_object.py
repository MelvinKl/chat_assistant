...
class VectorStoreObject(BaseModel):
    ...
    expires_at: Optional[StrictInt] = Field(
        default=None, description="The Unix timestamp (in seconds) for when the vector store will expire."
    )
    last_active_at: Optional[StrictInt] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "file_counts": (
                    VectorStoreObjectFileCounts.from_dict(obj.get("file_counts"))
                    if obj.get("file_counts") is not None
                    else None
                ),
