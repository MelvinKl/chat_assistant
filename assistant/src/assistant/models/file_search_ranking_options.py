...
from assistant.models.file_search_ranker import FileSearchRanker
...
class FileSearchRankingOptions(BaseModel):
    ...
    score_threshold: Union[
        Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]
    ] = Field(
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"ranker": obj.get("ranker"), "score_threshold": obj.get("score_threshold")})
        return _obj
