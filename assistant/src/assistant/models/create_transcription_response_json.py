...
class CreateTranscriptionResponseJson(BaseModel):
    ...
    logprobs: Optional[List[LogProbProperties]] = Field(default=None, description="The log probabilities of the tokens in the transcription. Only returned with the models `gpt-4o-transcribe` and `gpt-4o-mini-transcribe` if `logprobs` is added to the `include` array. ")
