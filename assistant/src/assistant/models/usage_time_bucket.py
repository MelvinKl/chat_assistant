...
from assistant.models.usage_time_bucket_result_inner import UsageTimeBucketResultInner
try:
...
class UsageTimeBucket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "start_time", "end_time", "result"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "result": [UsageTimeBucketResultInner.from_dict(_item) for _item in obj.get("result")] if obj.get("result") is not None else None
        })
        return _obj
