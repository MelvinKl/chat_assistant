...
class FunctionTool(BaseModel):
    ...
    parameters: Dict[str, Any] = Field(description="A JSON schema object describing the parameters of the function. ")
    strict: StrictBool = Field(description="Whether to enforce strict parameter validation. Default `true`. ")
