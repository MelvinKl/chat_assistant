...
from assistant.models.create_chat_completion_function_response_choices_inner import (
...
class CreateChatCompletionFunctionResponse(BaseModel):
    ...
    choices: List[CreateChatCompletionFunctionResponseChoicesInner] = Field(
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "choices": (
                    [CreateChatCompletionFunctionResponseChoicesInner.from_dict(_item) for _item in obj.get("choices")]
