...
from assistant.models.static_chunking_strategy_static import StaticChunkingStrategyStatic
try:
...
class StaticChunkingStrategy(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Always `static`.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "static": StaticChunkingStrategyStatic.from_dict(obj.get("static")) if obj.get("static") is not None else None
        })
        return _obj
