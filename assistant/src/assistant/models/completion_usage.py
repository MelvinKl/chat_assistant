        ...
        _obj = cls.model_validate(
            {
                ...
                "completion_tokens_details": (
                    CompletionUsageCompletionTokensDetails.from_dict(obj.get("completion_tokens_details"))
                    if obj.get("completion_tokens_details") is not None
                    else None
                ),
                "prompt_tokens_details": (
                    CompletionUsagePromptTokensDetails.from_dict(obj.get("prompt_tokens_details"))
                    if obj.get("prompt_tokens_details") is not None
                    else None
                ),
            }
        )
