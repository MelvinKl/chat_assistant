...
class TextResponseFormatJsonSchema(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="A description of what the response format is for, used by the model to determine how to respond in the format. ")
    name: Optional[StrictStr] = Field(default=None, description="The name of the response format. Must be a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64. ")
    var_schema: Dict[str, Any] = Field(description="The schema for the response format, described as a JSON Schema object. Learn how to build JSON schemas [here](https://json-schema.org/). ", alias="schema")
