...
from assistant.models.batch_request_output_error import BatchRequestOutputError
from assistant.models.batch_request_output_response import BatchRequestOutputResponse
...
class BatchRequestOutput(BaseModel):
    ...
    custom_id: Optional[StrictStr] = Field(
        default=None, description="A developer-provided per-request id that will be used to match outputs to inputs."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "response": (
                    BatchRequestOutputResponse.from_dict(obj.get("response"))
