...
from assistant.models.create_thread_request_tool_resources_file_search_vector_stores_inner import CreateThreadRequestToolResourcesFileSearchVectorStoresInner
try:
