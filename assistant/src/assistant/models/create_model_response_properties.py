...
class CreateModelResponseProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "temperature", "top_p", "user"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateModelResponseProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateModelResponseProperties from a dict"""
        if obj is None:
            return None
