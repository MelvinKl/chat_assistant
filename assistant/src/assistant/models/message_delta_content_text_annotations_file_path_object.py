...
from assistant.models.message_delta_content_text_annotations_file_path_object_file_path import (
        ...
        _obj = cls.model_validate(
            {
                ...
                "text": obj.get("text"),
                "file_path": (
                    MessageDeltaContentTextAnnotationsFilePathObjectFilePath.from_dict(obj.get("file_path"))
                    if obj.get("file_path") is not None
                    else None
                ),
