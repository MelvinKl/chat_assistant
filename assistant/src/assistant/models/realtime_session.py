...
from assistant.models.realtime_response_create_params_max_response_output_tokens import RealtimeResponseCreateParamsMaxResponseOutputTokens
...
class RealtimeSession(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the session that looks like `sess_1234567890abcdef`. ")
    ...
    input_audio_format: Optional[StrictStr] = Field(default='pcm16', description="The format of input audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. For `pcm16`, input audio must be 16-bit PCM at a 24kHz sample rate,  single channel (mono), and little-endian byte order. ")
    output_audio_format: Optional[StrictStr] = Field(default='pcm16', description="The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. For `pcm16`, output audio is sampled at a rate of 24kHz. ")
    ...
    tool_choice: Optional[StrictStr] = Field(default='auto', description="How the model chooses tools. Options are `auto`, `none`, `required`, or  specify a function. ")
    temperature: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.8, description="Sampling temperature for the model, limited to [0.6, 1.2]. For audio models a temperature of 0.8 is highly recommended for best performance. ")
    max_response_output_tokens: Optional[RealtimeResponseCreateParamsMaxResponseOutputTokens] = None
    __properties: ClassVar[List[str]] = ["id", "modalities", "model", "instructions", "voice", "input_audio_format", "output_audio_format", "input_audio_transcription", "turn_detection", "input_audio_noise_reduction", "tools", "tool_choice", "temperature", "max_response_output_tokens"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "input_audio_format": obj.get("input_audio_format") if obj.get("input_audio_format") is not None else 'pcm16',
            "output_audio_format": obj.get("output_audio_format") if obj.get("output_audio_format") is not None else 'pcm16',
            ...
            "input_audio_noise_reduction": RealtimeSessionInputAudioNoiseReduction.from_dict(obj.get("input_audio_noise_reduction")) if obj.get("input_audio_noise_reduction") is not None else None,
