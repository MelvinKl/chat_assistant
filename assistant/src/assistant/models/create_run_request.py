...
class CreateRunRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assistant_id", "model", "reasoning_effort", "instructions", "additional_instructions", "additional_messages", "tools", "metadata", "temperature", "top_p", "stream", "max_prompt_tokens", "max_completion_tokens", "truncation_strategy", "tool_choice", "parallel_tool_calls", "response_format"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "additional_messages": [CreateMessageRequest.from_dict(_item) for _item in obj.get("additional_messages")] if obj.get("additional_messages") is not None else None,
