...
class CreateRunRequest(BaseModel):
    ...
    additional_instructions: Optional[StrictStr] = Field(
        default=None,
    ...
    additional_messages: Optional[List[CreateMessageRequest]] = Field(
        default=None, description="Adds additional messages to the thread before creating the run."
    )
    tools: Optional[Annotated[List[AssistantObjectToolsInner], Field(max_length=20)]] = Field(
        default=None,
    ...
    truncation_strategy: Optional[CreateRunRequestTruncationStrategy] = None
    tool_choice: Optional[CreateRunRequestToolChoice] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "additional_messages": (
                    [CreateMessageRequest.from_dict(_item) for _item in obj.get("additional_messages")]
                    if obj.get("additional_messages") is not None
                    else None
                ),
                "tools": (
