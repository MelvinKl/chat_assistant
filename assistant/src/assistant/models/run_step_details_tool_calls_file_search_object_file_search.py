...
from assistant.models.run_step_details_tool_calls_file_search_result_object import (
...
class RunStepDetailsToolCallsFileSearchObjectFileSearch(BaseModel):
    ...
    results: Optional[List[RunStepDetailsToolCallsFileSearchResultObject]] = Field(
        default=None, description="The results of the file search."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "ranking_options": (
                    RunStepDetailsToolCallsFileSearchRankingOptionsObject.from_dict(obj.get("ranking_options"))
                    if obj.get("ranking_options") is not None
                    else None
                ),
                "results": (
                    [RunStepDetailsToolCallsFileSearchResultObject.from_dict(_item) for _item in obj.get("results")]
