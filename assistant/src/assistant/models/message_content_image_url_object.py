...
from assistant.models.message_content_image_url_object_image_url import MessageContentImageUrlObjectImageUrl
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "image_url": (
                    MessageContentImageUrlObjectImageUrl.from_dict(obj.get("image_url"))
