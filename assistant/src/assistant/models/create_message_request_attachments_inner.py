...
from assistant.models.create_message_request_attachments_inner_tools_inner import (
...
class CreateMessageRequestAttachmentsInner(BaseModel):
    ...
    tools: Optional[List[CreateMessageRequestAttachmentsInnerToolsInner]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "tools": (
                    [CreateMessageRequestAttachmentsInnerToolsInner.from_dict(_item) for _item in obj.get("tools")]
