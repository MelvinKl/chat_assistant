...
from assistant.models.realtime_server_event_error_error import RealtimeServerEventErrorError
try:
...
class RealtimeServerEventError(BaseModel):
    ...
    type: StrictStr = Field(description="The event type, must be `error`.")
    error: RealtimeServerEventErrorError
    __properties: ClassVar[List[str]] = ["event_id", "type", "error"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "error": RealtimeServerEventErrorError.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
