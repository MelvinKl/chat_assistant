...
from assistant.models.message_stream_event_one_of import MessageStreamEventOneOf
from assistant.models.message_stream_event_one_of1 import MessageStreamEventOneOf1
from assistant.models.message_stream_event_one_of2 import MessageStreamEventOneOf2
from assistant.models.message_stream_event_one_of3 import MessageStreamEventOneOf3
from assistant.models.message_stream_event_one_of4 import MessageStreamEventOneOf4
...
MESSAGESTREAMEVENT_ONE_OF_SCHEMAS = [
...
class MessageStreamEvent(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in MessageStreamEvent with oneOf schemas: MessageStreamEventOneOf, MessageStreamEventOneOf1, MessageStreamEventOneOf2, MessageStreamEventOneOf3, MessageStreamEventOneOf4. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in MessageStreamEvent with oneOf schemas: MessageStreamEventOneOf, MessageStreamEventOneOf1, MessageStreamEventOneOf2, MessageStreamEventOneOf3, MessageStreamEventOneOf4. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into MessageStreamEvent with oneOf schemas: MessageStreamEventOneOf, MessageStreamEventOneOf1, MessageStreamEventOneOf2, MessageStreamEventOneOf3, MessageStreamEventOneOf4. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into MessageStreamEvent with oneOf schemas: MessageStreamEventOneOf, MessageStreamEventOneOf1, MessageStreamEventOneOf2, MessageStreamEventOneOf3, MessageStreamEventOneOf4. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
