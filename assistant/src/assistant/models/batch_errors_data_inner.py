...
class BatchErrorsDataInner(BaseModel):
    ...
    message: Optional[StrictStr] = Field(
        default=None, description="A human-readable message providing more details about the error."
    )
    param: Optional[StrictStr] = Field(
        default=None, description="The name of the parameter that caused the error, if applicable."
    )
    line: Optional[StrictInt] = Field(
        default=None, description="The line number of the input file where the error occurred, if applicable."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"code": obj.get("code"), "message": obj.get("message"), "param": obj.get("param"), "line": obj.get("line")}
        )
        return _obj
