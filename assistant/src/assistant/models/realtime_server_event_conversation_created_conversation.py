...
class RealtimeServerEventConversationCreatedConversation(BaseModel):
    """
    The conversation resource.
    """  # noqa: E501

    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the conversation.")
    object: Optional[StrictStr] = Field(default=None, description="The object type, must be `realtime.conversation`.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "object": obj.get("object")})
        return _obj
