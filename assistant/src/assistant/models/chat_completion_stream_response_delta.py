...
from assistant.models.chat_completion_stream_response_delta_function_call import ChatCompletionStreamResponseDeltaFunctionCall
try:
...
class ChatCompletionStreamResponseDelta(BaseModel):
    ...
    refusal: Optional[StrictStr] = Field(default=None, description="The refusal message generated by the model.")
    __properties: ClassVar[List[str]] = ["content", "function_call", "tool_calls", "role", "refusal"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in ('developer', 'system', 'user', 'assistant', 'tool',):
