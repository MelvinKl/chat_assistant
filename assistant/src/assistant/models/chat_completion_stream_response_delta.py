        ...
        _obj = cls.model_validate(
            {
                ...
                "function_call": (
                    ChatCompletionStreamResponseDeltaFunctionCall.from_dict(obj.get("function_call"))
                    if obj.get("function_call") is not None
                    else None
                ),
                "tool_calls": (
                    [ChatCompletionMessageToolCallChunk.from_dict(_item) for _item in obj.get("tool_calls")]
