...
class ProjectServiceAccountApiKey(BaseModel):
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["object", "value", "name", "created_at", "id"]

    @field_validator("object")
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("organization.project.service_account.api_key",):
            raise ValueError("must be one of enum values ('organization.project.service_account.api_key')")
        return value
