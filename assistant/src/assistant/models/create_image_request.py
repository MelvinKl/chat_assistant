...
from assistant.models.create_image_request_model import CreateImageRequestModel
...
class CreateImageRequest(BaseModel):
    ...
    n: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = Field(
        default=1,
        description="The number of images to generate. Must be between 1 and 10. For `dall-e-3`, only `n=1` is supported.",
    )
    quality: Optional[StrictStr] = Field(
        default="standard",
