...
class FineTuneDPOMethodHyperparameters(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "beta": (
                    FineTuneDPOMethodHyperparametersBeta.from_dict(obj.get("beta"))
                    if obj.get("beta") is not None
                    else None
                ),
                "batch_size": (
                    FineTuneDPOMethodHyperparametersBatchSize.from_dict(obj.get("batch_size"))
                    if obj.get("batch_size") is not None
                    else None
                ),
                "learning_rate_multiplier": (
                    FineTuneDPOMethodHyperparametersLearningRateMultiplier.from_dict(
                        obj.get("learning_rate_multiplier")
                    )
                    if obj.get("learning_rate_multiplier") is not None
                    else None
                ),
                "n_epochs": (
                    FineTuneDPOMethodHyperparametersNEpochs.from_dict(obj.get("n_epochs"))
                    if obj.get("n_epochs") is not None
                    else None
                ),
            }
        )
