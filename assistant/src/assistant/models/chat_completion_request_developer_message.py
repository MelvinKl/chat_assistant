...
from assistant.models.chat_completion_request_developer_message_content import ChatCompletionRequestDeveloperMessageContent
try:
...
class ChatCompletionRequestDeveloperMessage(BaseModel):
    ...
    role: StrictStr = Field(description="The role of the messages author, in this case `developer`.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "content": ChatCompletionRequestDeveloperMessageContent.from_dict(obj.get("content")) if obj.get("content") is not None else None,
            "role": obj.get("role"),
            "name": obj.get("name")
        })
        return _obj
