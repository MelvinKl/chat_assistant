        ...
        _obj = cls.model_validate(
            {
                ...
                "input_tokens_details": (
                    ResponseUsageInputTokensDetails.from_dict(obj.get("input_tokens_details"))
                    if obj.get("input_tokens_details") is not None
                    else None
                ),
                "output_tokens": obj.get("output_tokens"),
                "output_tokens_details": (
                    ResponseUsageOutputTokensDetails.from_dict(obj.get("output_tokens_details"))
                    if obj.get("output_tokens_details") is not None
                    else None
                ),
