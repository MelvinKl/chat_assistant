...
from assistant.models.create_assistant_request_tool_resources_code_interpreter import CreateAssistantRequestToolResourcesCodeInterpreter
...
class CreateThreadRequestToolResources(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "file_search": CreateThreadRequestToolResourcesFileSearch.from_dict(obj.get("file_search")) if obj.get("file_search") is not None else None
        })
        return _obj
