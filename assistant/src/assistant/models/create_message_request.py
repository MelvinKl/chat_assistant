...
class CreateMessageRequest(BaseModel):
    ...
    attachments: Optional[List[CreateMessageRequestAttachmentsInner]] = Field(
        default=None, description="A list of files attached to the message, and the tools they should be added to."
    )
        ...
        _obj = cls.model_validate(
            {
                "role": obj.get("role"),
                "content": (
                    CreateMessageRequestContent.from_dict(obj.get("content"))
