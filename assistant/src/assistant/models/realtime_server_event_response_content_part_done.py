...
from assistant.models.realtime_server_event_response_content_part_done_part import (
        ...
        _obj = cls.model_validate(
            {
                ...
                "part": (
                    RealtimeServerEventResponseContentPartDonePart.from_dict(obj.get("part"))
                    if obj.get("part") is not None
                    else None
                ),
            }
        )
