...
from assistant.models.realtime_server_event_response_content_part_done_part import RealtimeServerEventResponseContentPartDonePart
try:
...
class RealtimeServerEventResponseContentPartDone(BaseModel):
    ...
    type: StrictStr = Field(description="The event type, must be `response.content_part.done`.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('response.content_part.done',):
            raise ValueError("must be one of enum values ('response.content_part.done')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "part": RealtimeServerEventResponseContentPartDonePart.from_dict(obj.get("part")) if obj.get("part") is not None else None
        })
        return _obj
