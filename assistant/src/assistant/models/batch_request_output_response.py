...
class BatchRequestOutputResponse(BaseModel):
    ...
    status_code: Optional[StrictInt] = Field(default=None, description="The HTTP status code of the response")
    ...
    body: Optional[Dict[str, Any]] = Field(default=None, description="The JSON body of the response")
    __properties: ClassVar[List[str]] = ["status_code", "request_id", "body"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"status_code": obj.get("status_code"), "request_id": obj.get("request_id"), "body": obj.get("body")}
        )
        return _obj
