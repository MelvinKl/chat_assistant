...
class StaticChunkingStrategyStatic(BaseModel):
    """
    StaticChunkingStrategyStatic
    """  # noqa: E501

    max_chunk_size_tokens: Annotated[int, Field(le=4096, strict=True, ge=100)] = Field(
    ...
    chunk_overlap_tokens: StrictInt = Field(
    ...
    __properties: ClassVar[List[str]] = ["max_chunk_size_tokens", "chunk_overlap_tokens"]
