...
class CreateModerationResponseResultsInnerCategories(BaseModel):
    ...
    illicit: Optional[StrictBool] = Field(description="Content that includes instructions or advice that facilitate the planning or execution of wrongdoing, or that gives advice or instruction on how to commit illicit acts. For example, \"how to shoplift\" would fit this category.")
    illicit_violent: Optional[StrictBool] = Field(description="Content that includes instructions or advice that facilitate the planning or execution of wrongdoing that also includes violence, or that gives advice or instruction on the procurement of any weapon.", alias="illicit/violent")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if illicit (nullable) is None
        # and model_fields_set contains the field
        if self.illicit is None and "illicit" in self.model_fields_set:
            _dict['illicit'] = None

        # set to None if illicit_violent (nullable) is None
        # and model_fields_set contains the field
        if self.illicit_violent is None and "illicit_violent" in self.model_fields_set:
            _dict['illicit/violent'] = None
