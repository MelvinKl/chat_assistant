...
class RealtimeResponseStatusDetails(BaseModel):
    ...
    type: Optional[StrictStr] = Field(
        default=None,
        description="The type of error that caused the response to fail, corresponding  with the `status` field (`completed`, `cancelled`, `incomplete`,  `failed`). ",
    )
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('turn_detected', 'client_cancelled', 'max_output_tokens', 'content_filter')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "error": (
                    RealtimeResponseStatusDetailsError.from_dict(obj.get("error"))
