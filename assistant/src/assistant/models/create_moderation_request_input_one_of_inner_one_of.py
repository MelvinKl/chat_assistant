...
from assistant.models.create_moderation_request_input_one_of_inner_one_of_image_url import CreateModerationRequestInputOneOfInnerOneOfImageUrl
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class CreateModerationRequestInputOneOfInnerOneOf(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "image_url": CreateModerationRequestInputOneOfInnerOneOfImageUrl.from_dict(obj.get("image_url")) if obj.get("image_url") is not None else None
        })
        return _obj
