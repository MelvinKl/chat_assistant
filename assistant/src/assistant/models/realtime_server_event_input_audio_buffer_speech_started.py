...
class RealtimeServerEventInputAudioBufferSpeechStarted(BaseModel):
    ...
    audio_start_ms: StrictInt = Field(
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("input_audio_buffer.speech_started",):
            raise ValueError("must be one of enum values ('input_audio_buffer.speech_started')")
        return value
