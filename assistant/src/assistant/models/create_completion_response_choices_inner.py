...
from assistant.models.create_completion_response_choices_inner_logprobs import CreateCompletionResponseChoicesInnerLogprobs
try:
...
class CreateCompletionResponseChoicesInner(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "logprobs": CreateCompletionResponseChoicesInnerLogprobs.from_dict(obj.get("logprobs")) if obj.get("logprobs") is not None else None,
            "text": obj.get("text")
        })
        return _obj
