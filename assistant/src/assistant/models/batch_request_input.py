...
class BatchRequestInput(BaseModel):
    ...
    method: Optional[StrictStr] = Field(
        default=None, description="The HTTP method to be used for the request. Currently only `POST` is supported."
    )
    ...
    __properties: ClassVar[List[str]] = ["custom_id", "method", "url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"custom_id": obj.get("custom_id"), "method": obj.get("method"), "url": obj.get("url")}
        )
        return _obj
