...
class UploadFile(BaseModel):
    ...
    purpose: StrictStr = Field(description="The intended purpose of the file. Supported values are `assistants`, `assistants_output`, `batch`, `batch_output`, `fine-tune`, `fine-tune-results` and `vision`.")
    ...
    __properties: ClassVar[List[str]] = ["id", "bytes", "created_at", "expires_at", "filename", "object", "purpose", "status", "status_details"]
    ...
    def purpose_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('assistants', 'assistants_output', 'batch', 'batch_output', 'fine-tune', 'fine-tune-results', 'vision',):
            raise ValueError("must be one of enum values ('assistants', 'assistants_output', 'batch', 'batch_output', 'fine-tune', 'fine-tune-results', 'vision')")
        return value
