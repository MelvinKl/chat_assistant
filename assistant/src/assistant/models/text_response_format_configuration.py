...
TEXTRESPONSEFORMATCONFIGURATION_ONE_OF_SCHEMAS = ["ResponseFormatJsonObject", "ResponseFormatText", "TextResponseFormatJsonSchema"]
...
class TextResponseFormatConfiguration(BaseModel):
    ...
    one_of_schemas: List[str] = Literal["ResponseFormatJsonObject", "ResponseFormatText", "TextResponseFormatJsonSchema"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in TextResponseFormatConfiguration with oneOf schemas: ResponseFormatJsonObject, ResponseFormatText, TextResponseFormatJsonSchema. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in TextResponseFormatConfiguration with oneOf schemas: ResponseFormatJsonObject, ResponseFormatText, TextResponseFormatJsonSchema. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into TextResponseFormatConfiguration with oneOf schemas: ResponseFormatJsonObject, ResponseFormatText, TextResponseFormatJsonSchema. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TextResponseFormatConfiguration with oneOf schemas: ResponseFormatJsonObject, ResponseFormatText, TextResponseFormatJsonSchema. Details: " + ", ".join(error_messages))
        else:
            return instance
