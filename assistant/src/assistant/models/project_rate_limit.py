...
class ProjectRateLimit(BaseModel):
    ...
    max_images_per_1_minute: Optional[StrictInt] = Field(
        default=None, description="The maximum images per minute. Only present for relevant models."
    )
    max_audio_megabytes_per_1_minute: Optional[StrictInt] = Field(
        default=None, description="The maximum audio megabytes per minute. Only present for relevant models."
    )
    max_requests_per_1_day: Optional[StrictInt] = Field(
        default=None, description="The maximum requests per day. Only present for relevant models."
    )
    batch_1_day_max_input_tokens: Optional[StrictInt] = Field(
        default=None, description="The maximum batch input tokens per day. Only present for relevant models."
    )
