...
from assistant.models.run_step_details_tool_calls_function_object_function import RunStepDetailsToolCallsFunctionObjectFunction
try:
...
class RunStepDetailsToolCallsFunctionObject(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "function": RunStepDetailsToolCallsFunctionObjectFunction.from_dict(obj.get("function")) if obj.get("function") is not None else None
        })
        return _obj
