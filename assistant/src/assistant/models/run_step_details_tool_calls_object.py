...
from assistant.models.run_step_details_tool_calls_object_tool_calls_inner import (
...
class RunStepDetailsToolCallsObject(BaseModel):
    ...
    tool_calls: List[RunStepDetailsToolCallsObjectToolCallsInner] = Field(
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "tool_calls": (
                    [RunStepDetailsToolCallsObjectToolCallsInner.from_dict(_item) for _item in obj.get("tool_calls")]
