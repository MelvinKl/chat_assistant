...
from assistant.models.fine_tuning_job_checkpoint_metrics import FineTuningJobCheckpointMetrics
...
class FineTuningJobCheckpoint(BaseModel):
    ...
    fine_tuned_model_checkpoint: StrictStr = Field(
    ...
    fine_tuning_job_id: StrictStr = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "metrics": (
                    FineTuningJobCheckpointMetrics.from_dict(obj.get("metrics"))
