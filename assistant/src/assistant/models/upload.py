...
from assistant.models.upload_file import UploadFile
try:
...
class Upload(BaseModel):
    ...
    expires_at: StrictInt = Field(description="The Unix timestamp (in seconds) for when the Upload will expire.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "file": UploadFile.from_dict(obj.get("file")) if obj.get("file") is not None else None
        })
        return _obj
