...
from assistant.models.create_moderation_response_results_inner import CreateModerationResponseResultsInner
        ...
        _obj = cls.model_validate(
            {
                ...
                "model": obj.get("model"),
                "results": (
                    [CreateModerationResponseResultsInner.from_dict(_item) for _item in obj.get("results")]
