...
from assistant.models.realtime_server_event_rate_limits_updated_rate_limits_inner import (
...
class RealtimeServerEventRateLimitsUpdated(BaseModel):
    ...
    rate_limits: List[RealtimeServerEventRateLimitsUpdatedRateLimitsInner] = Field(
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("rate_limits.updated",):
        ...
        _obj = cls.model_validate(
            {
                ...
                "rate_limits": (
                    [
                        RealtimeServerEventRateLimitsUpdatedRateLimitsInner.from_dict(_item)
                        for _item in obj.get("rate_limits")
                    ]
                    if obj.get("rate_limits") is not None
                    else None
                ),
            }
        )
