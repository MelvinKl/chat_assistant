...
from assistant.models.create_assistant_request_tool_resources_file_search_vector_stores_inner import (
...
class CreateAssistantRequestToolResourcesFileSearch(BaseModel):
    ...
    vector_store_ids: Optional[Annotated[List[StrictStr], Field(max_length=1)]] = Field(
        default=None,
    ...
    vector_stores: Optional[
        Annotated[List[CreateAssistantRequestToolResourcesFileSearchVectorStoresInner], Field(max_length=1)]
    ] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "vector_stores": (
                    [
                        CreateAssistantRequestToolResourcesFileSearchVectorStoresInner.from_dict(_item)
                        for _item in obj.get("vector_stores")
                    ]
                    if obj.get("vector_stores") is not None
                    else None
                ),
            }
        )
