...
class AuditLogApiKeyUpdatedChangesRequested(BaseModel):
    """
    The payload used to update the API key.
    """  # noqa: E501

    scopes: Optional[List[StrictStr]] = Field(
        default=None, description='A list of scopes allowed for the API key, e.g. `["api.model.request"]`'
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"scopes": obj.get("scopes")})
        return _obj
