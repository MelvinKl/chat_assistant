...
from assistant.models.assistant_object import AssistantObject
try:
...
class ListAssistantsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AssistantObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
