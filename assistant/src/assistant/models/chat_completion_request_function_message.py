...
class ChatCompletionRequestFunctionMessage(BaseModel):
    ...
    role: StrictStr = Field(description="The role of the messages author, in this case `function`.")
    content: Optional[StrictStr] = Field(description="The contents of the function message.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"role": obj.get("role"), "content": obj.get("content"), "name": obj.get("name")})
        return _obj
