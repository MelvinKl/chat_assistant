...
from assistant.models.run_step_details_tool_calls_code_output_image_object_image import (
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "image": (
                    RunStepDetailsToolCallsCodeOutputImageObjectImage.from_dict(obj.get("image"))
