...
from assistant.models.run_step_details_tool_calls_code_output_image_object_image import RunStepDetailsToolCallsCodeOutputImageObjectImage
try:
...
class RunStepDetailsToolCallsCodeOutputImageObject(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "image": RunStepDetailsToolCallsCodeOutputImageObjectImage.from_dict(obj.get("image")) if obj.get("image") is not None else None
        })
        return _obj
