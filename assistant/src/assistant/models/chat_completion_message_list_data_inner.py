...
from assistant.models.chat_completion_response_message_annotations_inner import ChatCompletionResponseMessageAnnotationsInner
...
class ChatCompletionMessageListDataInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content", "refusal", "tool_calls", "annotations", "role", "function_call", "audio", "id"]
