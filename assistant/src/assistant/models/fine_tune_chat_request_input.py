...
class FineTuneChatRequestInput(BaseModel):
    ...
    tools: Optional[List[ChatCompletionTool]] = Field(
        default=None, description="A list of tools the model may generate JSON inputs for."
    )
    ...
    functions: Optional[Annotated[List[ChatCompletionFunctions], Field(min_length=1, max_length=128)]] = Field(
        default=None, description="A list of functions the model may generate JSON inputs for."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "messages": (
                    [FineTuneChatRequestInputMessagesInner.from_dict(_item) for _item in obj.get("messages")]
