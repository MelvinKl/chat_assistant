...
from assistant.models.run_step_delta_step_details_tool_calls_code_object_code_interpreter import RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter
try:
...
class RunStepDeltaStepDetailsToolCallsCodeObject(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The ID of the tool call.")
    ...
    code_interpreter: Optional[RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter] = None
    __properties: ClassVar[List[str]] = ["index", "id", "type", "code_interpreter"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "type": obj.get("type"),
            "code_interpreter": RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.from_dict(obj.get("code_interpreter")) if obj.get("code_interpreter") is not None else None
        })
        return _obj
