...
class CreateFineTuningCheckpointPermissionRequest(BaseModel):
    ...
    project_ids: List[StrictStr] = Field(description="The project identifiers to grant access to.")
    __properties: ClassVar[List[str]] = ["project_ids"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"project_ids": obj.get("project_ids")})
        return _obj
