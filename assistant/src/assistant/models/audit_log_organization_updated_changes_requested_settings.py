...
class AuditLogOrganizationUpdatedChangesRequestedSettings(BaseModel):
    """
    AuditLogOrganizationUpdatedChangesRequestedSettings
    """  # noqa: E501

    threads_ui_visibility: Optional[StrictStr] = Field(
        default=None,
    ...
    usage_dashboard_visibility: Optional[StrictStr] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["threads_ui_visibility", "usage_dashboard_visibility"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "threads_ui_visibility": obj.get("threads_ui_visibility"),
                "usage_dashboard_visibility": obj.get("usage_dashboard_visibility"),
            }
        )
        return _obj
