...
class ResponseFailedEvent(BaseModel):
    ...
    type: StrictStr = Field(description="The type of the event. Always `response.failed`. ")
    response: Response
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ("response.failed",):
            raise ValueError("must be one of enum values ('response.failed')")
        return value
