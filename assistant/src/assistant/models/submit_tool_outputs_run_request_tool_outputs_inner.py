...
class SubmitToolOutputsRunRequestToolOutputsInner(BaseModel):
    ...
    tool_call_id: Optional[StrictStr] = Field(
        default=None,
    ...
    output: Optional[StrictStr] = Field(
        default=None, description="The output of the tool call to be submitted to continue the run."
    )
    __properties: ClassVar[List[str]] = ["tool_call_id", "output"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"tool_call_id": obj.get("tool_call_id"), "output": obj.get("output")})
        return _obj
