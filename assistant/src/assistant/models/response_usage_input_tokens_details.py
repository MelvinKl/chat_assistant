...
class ResponseUsageInputTokensDetails(BaseModel):
    ...
    cached_tokens: StrictInt = Field(
        description="The number of tokens that were retrieved from the cache.  [More on prompt caching](/docs/guides/prompt-caching). "
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"cached_tokens": obj.get("cached_tokens")})
        return _obj
