...
class MessageObjectIncompleteDetails(BaseModel):
    """
    On an incomplete message, details about why the message is incomplete.
    """  # noqa: E501

    reason: StrictStr = Field(description="The reason the message is incomplete.")
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('content_filter', 'max_tokens', 'run_cancelled', 'run_expired', 'run_failed')"
            )
        return value
