...
class CompletionUsageCompletionTokensDetails(BaseModel):
    ...
    accepted_prediction_tokens: Optional[StrictInt] = Field(
        default=0,
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "accepted_prediction_tokens": (
                    obj.get("accepted_prediction_tokens") if obj.get("accepted_prediction_tokens") is not None else 0
                ),
                ...
                "rejected_prediction_tokens": (
                    obj.get("rejected_prediction_tokens") if obj.get("rejected_prediction_tokens") is not None else 0
                ),
            }
        )
        return _obj
