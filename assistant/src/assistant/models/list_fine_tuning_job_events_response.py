...
from assistant.models.fine_tuning_job_event import FineTuningJobEvent
try:
...
class ListFineTuningJobEventsResponse(BaseModel):
    ...
    object: StrictStr
    has_more: StrictBool
    __properties: ClassVar[List[str]] = ["data", "object", "has_more"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [FineTuningJobEvent.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
