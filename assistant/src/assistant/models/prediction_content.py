...
from assistant.models.prediction_content_content import PredictionContentContent
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "content": (
                    PredictionContentContent.from_dict(obj.get("content")) if obj.get("content") is not None else None
                ),
            }
        )
        return _obj
