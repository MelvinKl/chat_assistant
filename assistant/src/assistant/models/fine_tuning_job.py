...
from assistant.models.fine_tuning_job_error import FineTuningJobError
from assistant.models.fine_tuning_job_hyperparameters import FineTuningJobHyperparameters
from assistant.models.fine_tuning_job_integrations_inner import FineTuningJobIntegrationsInner
...
class FineTuningJob(BaseModel):
    ...
    result_files: List[StrictStr] = Field(
    ...
    trained_tokens: Optional[StrictInt] = Field(
    ...
    integrations: Optional[Annotated[List[FineTuningJobIntegrationsInner], Field(max_length=5)]] = Field(
        default=None, description="A list of integrations to enable for this fine-tuning job."
    )
    seed: StrictInt = Field(description="The seed used for the fine-tuning job.")
    estimated_finish: Optional[StrictInt] = Field(
        default=None,
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('validating_files', 'queued', 'running', 'succeeded', 'failed', 'cancelled')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "hyperparameters": (
                    FineTuningJobHyperparameters.from_dict(obj.get("hyperparameters"))
                ...
                "integrations": (
                    [FineTuningJobIntegrationsInner.from_dict(_item) for _item in obj.get("integrations")]
