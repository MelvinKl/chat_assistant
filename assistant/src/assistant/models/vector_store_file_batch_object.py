...
from assistant.models.vector_store_file_batch_object_file_counts import VectorStoreFileBatchObjectFileCounts
        ...
        _obj = cls.model_validate(
            {
                ...
                "file_counts": (
                    VectorStoreFileBatchObjectFileCounts.from_dict(obj.get("file_counts"))
