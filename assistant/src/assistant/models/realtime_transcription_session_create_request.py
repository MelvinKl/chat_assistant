...
from assistant.models.realtime_transcription_session_create_request_input_audio_transcription import RealtimeTranscriptionSessionCreateRequestInputAudioTranscription
from assistant.models.realtime_transcription_session_create_request_turn_detection import RealtimeTranscriptionSessionCreateRequestTurnDetection
try:
...
class RealtimeTranscriptionSessionCreateRequest(BaseModel):
    ...
    include: Optional[List[StrictStr]] = Field(default=None, description="The set of items to include in the transcription. Current available items are: - `item.input_audio_transcription.logprobs` ")
    __properties: ClassVar[List[str]] = ["modalities", "input_audio_format", "input_audio_transcription", "turn_detection", "input_audio_noise_reduction", "include"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "input_audio_transcription": RealtimeTranscriptionSessionCreateRequestInputAudioTranscription.from_dict(obj.get("input_audio_transcription")) if obj.get("input_audio_transcription") is not None else None,
            "turn_detection": RealtimeTranscriptionSessionCreateRequestTurnDetection.from_dict(obj.get("turn_detection")) if obj.get("turn_detection") is not None else None,
