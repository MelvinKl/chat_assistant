...
from assistant.models.update_vector_store_request_expires_after import UpdateVectorStoreRequestExpiresAfter
try:
...
class UpdateVectorStoreRequest(BaseModel):
    ...
    expires_after: Optional[UpdateVectorStoreRequestExpiresAfter] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "expires_after": UpdateVectorStoreRequestExpiresAfter.from_dict(obj.get("expires_after")) if obj.get("expires_after") is not None else None,
