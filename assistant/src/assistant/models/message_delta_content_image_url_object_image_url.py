...
class MessageDeltaContentImageUrlObjectImageUrl(BaseModel):
    """
    MessageDeltaContentImageUrlObjectImageUrl
    """  # noqa: E501

    url: Optional[StrictStr] = Field(
        default=None, description="The URL of the image, must be a supported image types: jpeg, jpg, png, gif, webp."
    )
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"url": obj.get("url"), "detail": obj.get("detail") if obj.get("detail") is not None else "auto"}
        )
        return _obj
