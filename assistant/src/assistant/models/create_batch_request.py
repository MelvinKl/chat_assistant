...
class CreateBatchRequest(BaseModel):
    ...
    completion_window: StrictStr = Field(
    ...
    def endpoint_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('/v1/responses', '/v1/chat/completions', '/v1/embeddings', '/v1/completions')"
            )
        return value
