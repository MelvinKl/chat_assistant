...
class CreateBatchRequest(BaseModel):
    ...
    endpoint: StrictStr = Field(description="The endpoint to be used for all requests in the batch. Currently `/v1/responses`, `/v1/chat/completions`, `/v1/embeddings`, and `/v1/completions` are supported. Note that `/v1/embeddings` batches are also restricted to a maximum of 50,000 embedding inputs across all requests in the batch.")
    ...
    def endpoint_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('/v1/responses', '/v1/chat/completions', '/v1/embeddings', '/v1/completions',):
            raise ValueError("must be one of enum values ('/v1/responses', '/v1/chat/completions', '/v1/embeddings', '/v1/completions')")
        return value
