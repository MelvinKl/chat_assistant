...
class ModifyAssistantRequestToolResourcesFileSearch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vector_store_ids"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({"vector_store_ids": obj.get("vector_store_ids")})
        return _obj
