...
class VectorStoreFileObject(BaseModel):
    ...
    vector_store_id: StrictStr = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "last_error": (
                    VectorStoreFileObjectLastError.from_dict(obj.get("last_error"))
                    if obj.get("last_error") is not None
                    else None
                ),
                "chunking_strategy": (
                    VectorStoreFileObjectChunkingStrategy.from_dict(obj.get("chunking_strategy"))
