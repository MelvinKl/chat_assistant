...
from assistant.models.model_ids_shared import ModelIdsShared
...
from assistant.models.web_search import WebSearch
...
class CreateChatCompletionRequest(BaseModel):
    ...
    messages: Annotated[List[ChatCompletionRequestMessage], Field(min_length=1)] = Field(
    ...
    frequency_penalty: Optional[
        Union[Annotated[float, Field(le=2, strict=True, ge=-2)], Annotated[int, Field(le=2, strict=True, ge=-2)]]
    ] = Field(
        default=0,
    ...
    service_tier: Optional[StrictStr] = Field(
        default="auto",
    ...
    prediction: Optional[CreateChatCompletionRequestAllOfPrediction] = None
    ...
    functions: Optional[Annotated[List[ChatCompletionFunctions], Field(min_length=1, max_length=128)]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "user": obj.get("user"),
                "messages": (
                    [ChatCompletionRequestMessage.from_dict(_item) for _item in obj.get("messages")]
                ...
                "reasoning_effort": (
                    obj.get("reasoning_effort") if obj.get("reasoning_effort") is not None else ReasoningEffort.MEDIUM
                ),
                ...
                "web_search_options": (
                    WebSearch.from_dict(obj.get("web_search_options"))
                    if obj.get("web_search_options") is not None
                    else None
                ),
                "top_logprobs": obj.get("top_logprobs"),
                "response_format": (
                    CreateChatCompletionRequestAllOfResponseFormat.from_dict(obj.get("response_format"))
                    if obj.get("response_format") is not None
                    else None
                ),
                "service_tier": obj.get("service_tier") if obj.get("service_tier") is not None else "auto",
                "audio": (
                    CreateChatCompletionRequestAllOfAudio.from_dict(obj.get("audio"))
                ...
                "prediction": (
                    CreateChatCompletionRequestAllOfPrediction.from_dict(obj.get("prediction"))
                    if obj.get("prediction") is not None
                    else None
                ),
                "seed": obj.get("seed"),
                "stream_options": (
                    ChatCompletionStreamOptions.from_dict(obj.get("stream_options"))
                    if obj.get("stream_options") is not None
                    else None
                ),
                "tools": (
                ...
                "tool_choice": (
                    ChatCompletionToolChoiceOption.from_dict(obj.get("tool_choice"))
                ...
                "function_call": (
                    CreateChatCompletionRequestAllOfFunctionCall.from_dict(obj.get("function_call"))
                    if obj.get("function_call") is not None
                    else None
                ),
                "functions": (
                    [ChatCompletionFunctions.from_dict(_item) for _item in obj.get("functions")]
