...
from assistant.models.realtime_transcription_session_create_request import (
    RealtimeTranscriptionSessionCreateRequest,
)  # noqa: F401
from assistant.models.realtime_transcription_session_create_response import (
...
def test_create_realtime_session(client: TestClient):
    ...
    realtime_session_create_request = {
        ...
        "input_audio_transcription": {"model": "model", "language": "language", "prompt": "prompt"},
        "turn_detection": {
            "silence_duration_ms": 1,
            "create_response": 1,
            "interrupt_response": 1,
            "prefix_padding_ms": 6,
            "eagerness": "auto",
        ...
        "tools": [
            {"name": "name", "description": "description", "type": "function", "parameters": "{}"},
            {"name": "name", "description": "description", "type": "function", "parameters": "{}"},
        ],
...
def test_create_realtime_transcription_session(client: TestClient):
    ...
    realtime_transcription_session_create_request = {
        ...
        "modalities": ["text", "text"],
        "input_audio_noise_reduction": {"type": "near_field"},
        "input_audio_transcription": {"model": "gpt-4o-transcribe", "language": "language", "prompt": "prompt"},
        "turn_detection": {
            "silence_duration_ms": 1,
            "create_response": 1,
            "interrupt_response": 1,
