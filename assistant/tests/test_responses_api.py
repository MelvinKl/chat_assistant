...
def test_create_response(client: TestClient):
    ...
    create_response = {
        ...
        "include": ["file_search_call.results", "file_search_call.results"],
        "metadata": {"key": "metadata"},
        "reasoning": {"effort": "medium", "generate_summary": "concise"},
        "store": 1,
        "tools": [
            {
                "vector_store_ids": ["vector_store_ids", "vector_store_ids"],
                "max_num_results": 6,
                "ranking_options": {"score_threshold": 0.14658129805029452, "ranker": "auto"},
