...
from assistant.models.update_vector_store_file_attributes_request import UpdateVectorStoreFileAttributesRequest  # noqa: F401
...
def test_create_vector_store(client: TestClient):
    ...
    """
    create_vector_store_request = {"chunking_strategy":{"type":"auto"},"metadata":{"key":"metadata"},"expires_after":{"anchor":"last_active_at","days":339},"file_ids":["file_ids","file_ids","file_ids","file_ids","file_ids"],"name":"name"}
...
def test_create_vector_store_file(client: TestClient):
    ...
    """
    create_vector_store_file_request = {"chunking_strategy":{"type":"auto"},"file_id":"file_id","attributes":{"key":"VectorStoreFileAttributes_value"}}
...
def test_create_vector_store_file_batch(client: TestClient):
    ...
    """
    create_vector_store_file_batch_request = {"chunking_strategy":{"type":"auto"},"file_ids":["file_ids","file_ids","file_ids","file_ids","file_ids"],"attributes":{"key":"VectorStoreFileAttributes_value"}}
...
def test_modify_vector_store(client: TestClient):
    ...
    """
    update_vector_store_request = {"metadata":{"key":"metadata"},"expires_after":{"anchor":"last_active_at","days":30},"name":"name"}
...
def test_search_vector_store(client: TestClient):
    ...
    """
    vector_store_search_request = {"max_num_results":4,"ranking_options":{"score_threshold":0.6027456183070403,"ranker":"auto"},"query":"VectorStoreSearchRequest_query","rewrite_query":0,"filters":{"type":"eq","value":"ComparisonFilter_value","key":"key"}}
