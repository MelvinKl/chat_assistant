...
class TestChatGraph:
    ...
    def test_add_nodes_calls_state_graph_correctly(self, chat_graph):
        with (
            ...
            sg_mock.add_node.assert_any_call(GraphNodeNames.ADD_DYNAMIC_KNOWLEDGE, chat_graph._add_dynamic_knowledge_node)
            ...
            sg_mock.add_node.assert_any_call(GraphNodeNames.UPDATE_DYNAMIC_KNOWLEDGE, chat_graph._update_knowledge_node)
